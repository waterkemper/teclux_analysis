inherited frmcadastrobancos: Tfrmcadastrobancos
  Left = 514
  Top = 131
  HelpKeyword = 'banco.html'
  ActiveControl = edfCodigoProcura
    ...
    object gbxFundoJanela: TGroupBox
      ...
      object gbxAgencias: TGroupBox
        ...
        object dbgAgencias: TtecDBGrid
          ...
          TitleFont.Style = []
          OnCellClick = dbgAgenciasCellClick
          OnDblClick = dbgAgenciasDblClick
          OnKeyDown = dbgAgenciasKeyDown
          OnKeyUp = dbgAgenciasKeyUp
          RowWrap = 60
          Large = False
          DoubleRowColor = False
          MsgDelete = 'a AG'#202'NCIA'
          TitleMinHeight = 100
          CellHeights = 100
          ...
          Columns = <
            ...
            item
              ...
              FieldName = 'nome'
              Title.Alignment = taCenter
              Title.Caption = 'NOME DA AG'#202'NCIA'
              Title.Font.Charset = DEFAULT_CHARSET
              Title.Font.Color = clBlack
              Title.Font.Height = -9
              Title.Font.Name = 'Arial'
        ...
        object plnAgencias: TPanel
          ...
          Align = alRight
          TabOrder = 1
          object sbnExcluirAgencias: TSpeedButton
            Left = 4
            Top = 35
            Width = 22
            Height = 22
            Hint = 'Excluir Ag'#234'ncia'
            Flat = True
            Glyph.Data = {
            ...
            NumGlyphs = 2
            OnClick = sbnExcluirAgenciasClick
          end
          object sbnIncluirAgencias: TSpeedButton
            Left = 4
            Top = 12
            Width = 22
            Height = 22
            Hint = 'Incluir Ag'#234'ncia'
            Flat = True
            Glyph.Data = {
              36060000424D3606000000000000360000002800000020000000100000000100
              18000000000000060000120B0000120B00000000000000000000DCDCDCDCDCDC
              ...
              DCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDC}
            NumGlyphs = 2
            OnClick = sbnIncluirAgenciasClick
          end
        end
      end
      object gbxContas: TGroupBox
        ...
        object Panel1: TPanel
          ...
          Align = alRight
          TabOrder = 0
          object sbnExcluirContas: TSpeedButton
            Left = 5
            Top = 36
            Width = 22
            Height = 22
            ...
            Glyph.Data = {
              ...
              DCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDC}
            NumGlyphs = 2
            OnClick = sbnExcluirContasClick
          end
          object sbnIncluirContas: TSpeedButton
            Left = 5
            Top = 13
            Width = 22
            Height = 22
      ...
      object gbxBanco: TGroupBox
        ...
        ParentFont = False
        TabOrder = 2
        object gbxCodigoBanco: TGroupBox
          Left = 6
          Top = 13
          Width = 60
          Height = 36
      ...
      object gbxModeloCheque: TGroupBox
        Left = 4
        Top = 99
        Width = 403
        Height = 36
        Caption = 'MODELO DE CHEQUE'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -9
        Font.Name = 'helvetica'
        ...
        ParentFont = False
        TabOrder = 3
        object sbnProcurarModeloCheque: TSpeedButton
          Left = 60
          Top = 10
          Width = 23
          Height = 23
          Hint = 'Procurar  Modelo Cheque'
          Flat = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
          ...
          NumGlyphs = 2
          ParentFont = False
          OnClick = sbnProcurarModeloChequeClick
        end
        object flkModeloCheque: TtecDBFindLookup
          Left = 2
          Top = 10
          Width = 54
          Height = 23
          Alignment = taLeftJustify
          DataField = 'modelocheque'
          DataSource = dtmcadastrobancos.dsrBancos
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          ...
          Operacao = opATRIBUICAO
          LookupField = 'codigo'
          LookupSource = dtmcadastrobancos.dsrModelosCheque
        ...
        object dtxModeloNota: TtecDBText
          ...
          Color = clBtnFace
          DataField = 'descricao'
          DataSource = dtmcadastrobancos.dsrModelosCheque
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
      ...
      object gbxRemessa: TGroupBox
        ...
        ParentFont = False
        TabOrder = 4
        object lblDiasUteis: TLabel
          Left = 15
          Top = 22
          Width = 143
          Height = 15
          Alignment = taRightJustify
          Caption = 'Dias '#250'teis cheque a prazo'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
        ...
        object lblValorLimite: TLabel
          ...
          Height = 15
          Alignment = taRightJustify
          Caption = 'Valor limite do cheque'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
        ...
        object lblQtdeChequeVista: TLabel
          Left = 283
          Top = 22
          Width = 119
          Height = 15
          Alignment = taRightJustify
          Caption = 'N'#186' de cheques '#224' vista'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
        ...
        object lblQtdeChequePrazo: TLabel
          Left = 278
          Top = 49
          Width = 124
          Height = 15
          Alignment = taRightJustify
          Caption = 'N'#186' de cheques a prazo'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
        ...
        object edtDiasUteis: TDBEditNumero
          ...
          Negativo = False
          Tamanho = 3
          DataField = 'diasuteisremessa'
          DataSource = dtmcadastrobancos.dsrBancos
        end
        object edtValorLimite: TDBEditNumero
          Left = 162
          Top = 45
          Width = 100
          Height = 23
          ...
          Negativo = False
          Tamanho = 9
          DataField = 'valorlimitecheque'
          DataSource = dtmcadastrobancos.dsrBancos
        end
        object edtQtdeChequeVista: TDBEditNumero
          Left = 406
          Top = 18
          Width = 40
          Height = 23
          ...
          Negativo = False
          Tamanho = 3
          DataField = 'qtdechequevista'
          DataSource = dtmcadastrobancos.dsrBancos
        end
        object edtQtdeChequePrazo: TDBEditNumero
          Left = 406
          Top = 45
          Width = 40
          Height = 23
