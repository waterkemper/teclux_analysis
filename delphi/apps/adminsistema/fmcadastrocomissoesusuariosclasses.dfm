inherited frmCadastroComissoesUsuariosClasses: TfrmCadastroComissoesUsuariosClasses
  Left = 359
  Top = 234
  ActiveControl = flkClasse
  Caption = 'Cadastro de Comiss'#245'es de Usuarios sob Classes'
  ClientHeight = 192
  ClientWidth = 476
  Color = clBtnFace
  PixelsPerInch = 96
  ...
  inherited pnlBarra: TPanel
    ...
    object gbxComissoesUsuarios: TGroupBox
      ...
      Align = alClient
      TabOrder = 0
      object sbnProcurarClasses: TSpeedButton
        Left = 71
        Top = 15
        Width = 23
        Height = 23
        ...
        NumGlyphs = 2
        OnClick = sbnProcurarClassesClick
      end
      object flkClasse: TtecDBFindLookup
        ...
        LookupField = 'codigo'
        LookupSource = dtmCadastrosInternos.dsrProcuraClasses
        Parameter = ' '
      ...
      object dtxGrupo: TtecDBText
        ...
        Color = clBtnFace
        DataField = 'descricao'
        DataSource = dtmCadastrosInternos.dsrProcuraClasses
        ReadOnly = True
        TabOrder = 1
      end
