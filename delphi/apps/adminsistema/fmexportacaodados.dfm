inherited frmExportacaoDados: TfrmExportacaoDados
  ...
  object gbxDefinicao: TGroupBox [0]
    ...
    object gbxModelo: TGroupBox
      ...
      object dblSeparadorDecimal: TTecDBLookupComboBox
        Left = 595
        Top = 12
        Width = 35
        Height = 22
        DataField = 'separadordecimal'
        ...
        KeyField = 'separador'
        ListField = 'separador'
        ListSource = dtmExportacaoDados.dsrSeparadorDecimal
        ParentFont = False
        TabOrder = 4
      end
      object dblSeparadorMilhar: TTecDBLookupComboBox
        Left = 673
        Top = 12
        Width = 35
        Height = 22
        DataField = 'separadormilhar'
        DataSource = dtmExportacaoDados.dsrExportacaoModelos
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        ...
        KeyField = 'separador'
        ListField = 'separador'
        ListSource = dtmExportacaoDados.dsrSeparadorMilhar
        ParentFont = False
        TabOrder = 0
      end
      object dblSeparadorColuna: TTecDBLookupComboBox
        Left = 756
        Top = 12
        Width = 35
        Height = 22
        DataField = 'separadorcampos'
        DataSource = dtmExportacaoDados.dsrExportacaoModelos
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        ...
        KeyField = 'separador'
        ListField = 'separador'
        ListSource = dtmExportacaoDados.dsrSeparadorCampos
        ParentFont = False
        TabOrder = 1
      end
