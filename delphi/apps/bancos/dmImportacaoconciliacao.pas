...
uses
  ...
  fmPrincipalBasico, forms;

type
  TdtmImportacaoConciliacao = class(TdtmBasico)
...
var
  dtmImportacaoConciliacao: TdtmImportacaoConciliacao;

implementation

{$R *.dfm}

{ TdtmImportacaoConciliacao }

constructor TdtmImportacaoConciliacao.Create(AOwner: TComponent);
begin
  inherited;

end;

function TdtmImportacaoConciliacao.ImportarConciliacao(Arquivo: String): Boolean;
var
 i: integer;
...
procedure TdtmImportacaoConciliacao.qryconciliacaoextratoAfterScroll(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TdtmImportacaoConciliacao.qryMovtosBancosEventosAfterPost(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TdtmImportacaoConciliacao.dsrMovtosBancosEventosDataChange(
...
function TdtmImportacaoConciliacao.Gravar: Boolean;
begin
...
procedure TdtmImportacaoConciliacao.qryconciliacaoextratoCalcFields(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TdtmImportacaoConciliacao.qryConciliacaoCalcFields(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TdtmImportacaoConciliacao.qryConciliacaoNewRecord(
  DataSet: TDataSet);
begin
  inherited;
...
function TdtmImportacaoConciliacao.Cancelar: Boolean;
begin
...
procedure TdtmImportacaoConciliacao.qryMovtosBancosEventosconciliarChange(
  Sender: TField);
begin
  inherited;
...
function TdtmImportacaoConciliacao.Excluir: Boolean;
begin
{
...
procedure TdtmImportacaoConciliacao.GuardarPosicaoMovtosBancosEventos;
begin
...
procedure TdtmImportacaoConciliacao.RestaurarPosicaoMovtosBancosEventos;
begin
...
function TdtmImportacaoConciliacao.GerarConsultaConciliacao(DataInicial,
...
procedure TdtmImportacaoConciliacao.Selecionar(
...
function TdtmImportacaoConciliacao.ExisteConta(campo,
  codigo: string): boolean;
begin
  Result:= ExisteCodigo(qryConsultaContas, campo, codigo);
end;

procedure TdtmImportacaoConciliacao.AbrirDocumentos;
begin
  ...
  begin
    RefazConsultaPorNome(qryDuplicatas, ['conta','data','sequencia','evento','sequenciaevento'],
      [dtmImportacaoConciliacao.qryMovtosBancosEventosconta.AsInteger,
       dtmImportacaoConciliacao.qryMovtosBancosEventosData.AsDateTime,
       dtmImportacaoConciliacao.qryMovtosBancosEventosSequencia.AsInteger,
       dtmImportacaoConciliacao.qryMovtosBancosEventosEvento.AsInteger,
       dtmImportacaoConciliacao.qryMovtosBancosEventosSequenciaEvento.AsInteger]);

    if qryDuplicatas.recordcount = 1 then
      TfrmPrincipalBasico(Application.MainForm).
              MostrarFormRegistrado([dtmImportacaoConciliacao.qryDuplicatasdocumentopag.AsInteger,
                                     dtmImportacaoConciliacao.qryDuplicatasnumero.AsInteger,
                                     dtmImportacaoConciliacao.qryDuplicatasdatavencto.AsDateTime
  ...
  begin
    RefazConsultaPorNome(qryparcelas, ['conta','data','sequencia','evento','valorpagto'],
      [dtmImportacaoConciliacao.qryMovtosBancosEventosconta.AsInteger,
       ...
       dtmImportacaoConciliacao.qryMovtosBancosEventosSequencia.AsInteger,
       dtmImportacaoConciliacao.qryMovtosBancosEventosEvento.AsInteger,
       dtmImportacaoConciliacao.qryMovtosBancosEventosvalor.AsFloat]);

    if qryparcelas.recordcount = 1 then
      TfrmPrincipalBasico(Application.MainForm).
              MostrarFormRegistrado([dtmImportacaoConciliacao.qryparcelasContrato.AsString,
                                     dtmImportacaoConciliacao.qryParcelasnumero.AsInteger
