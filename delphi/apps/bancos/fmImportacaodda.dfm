inherited frmImportacaoDDA: TfrmImportacaoDDA
  Left = 229
  Top = 83
  ...
  object pnlImportacao: TPanel
    ...
    object dbgImportacao: TDBAdvGrid
      ...
      DataSource = dtmImportacaoDDA.dsrconciliacaoextrato
      InvalidPicture.Data = {
  ...
  object gbxLancamentosaImportar: TGroupBox
    ...
    object dtxStatus: TtecDBText
      ...
      Color = clBtnFace
      DataField = 'status'
      DataSource = dtmImportacaoDDA.dsrConciliacao
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -20
      Font.Name = 'helvetica'
    ...
    inline fraLerContaCorrenteSaldo1: TfraLerContaCorrenteSaldo
      ...
      inherited dsrProcuraContas: TtecDataSource
        DataSet = dtmImportacaoDDA.qryProcuraContas
        Left = 408
      end
    end
    object pgcSelecaoDados: TPageControl
      ...
      object tstImportacaoOFX: TTabSheet
        ...
        object dtxBanco: TtecDBText
          ...
          Color = clBtnFace
          DataField = 'sigla'
          DataSource = dtmImportacaoDDA.dsrContaConciliacao
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          Font.Name = 'helvetica'
  ...
  object dbgconciliacaoextratoitems: TDBAdvGrid
    ...
    DataSource = dtmImportacaoDDA.dsrMovtosBancosEventos
    InvalidPicture.Data = {
      055449636F6E0000010001002020040000000000E80200001600000028000000
      2000000040000000010004000000000000020000000000000000000000000000
      0000000000000000000080000080000000808000800000008000800080800000
