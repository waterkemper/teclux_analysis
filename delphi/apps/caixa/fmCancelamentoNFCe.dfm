inherited frmCancelamentoNFCe: TfrmCancelamentoNFCe
  Left = 462
  Top = 112
  ...
  object pnlFiltros: TPanel
    ...
    object gbxEmissao: TGroupBox
      ...
      ParentFont = False
      TabOrder = 0
      object stxDataAtual: TStaticText
        Left = 8
        Top = 13
        Width = 4
        Height = 4
  ...
  object dbgNotas: TtecDBGrid
    ...
    Columns = <
      ...
      item
        Alignment = taCenter
        Expanded = False
        FieldName = 'MinRestantes'
        Title.Caption = 'MINUTOS RESTANTES'
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clBlack
        Title.Font.Height = -9
        Title.Font.Name = 'helvetica'
  ...
  object qryDadosFiscais: TtecQuery
    ...
    Sql.Strings = (
      ...
      '                   df.numprotocolonfe IS NOT NULL and'
      
        '                   df.numcancelamentonfe IS NULL      then  cast' +
        '('#39'CANCELAR'#39' as varchar(20))'
      '              when df.situacao = '#39'N'#39' and'
      
        '                   df.numprotocolonfe IS NULL         then cast(' +
        #39'TRANSMITIR'#39' as varchar(20))'
      '              when df.chv_nfe is not null and'
      '                   df.modelodocto in ('#39'55'#39','#39'65'#39') and'
      '                   df.situacao = '#39'C'#39' and'
      '                   df.numprotocolonfe IS NULL and'
      
        '                   df.numinutilizacaonfe IS NULL      then cast(' +
        #39'INUTILIZAR'#39' as varchar(20))'
      '         end as operacao,'
      ''
      '         n.filial,'
      '         n.serie,'
      ...
      '         df.situacao,'
        ...
        '         cast(df.chv_nfe|| cast(df.digchaveacesso as varchar) as' +
        ' char(44)) as chave_nfe,'
      ...
      '         df.orcamento,'
        ...
        '         cast(coalesce(parametros_valor('#39'Limite em minutos para ' +
        'cancelamento da NFCe'#39', df.filialemissao),'#39'0'#39') as INTEGER) as Lim' +
        'iteMinutos,'
      ...
      '    and df.modelodocto in ('#39'65'#39')'
      '    AND df.data = current_date'
      '    AND df.ambiente = :ambiente'
      #9'   /*and df.vendedor = :UsuarioCaixa*/'
      '    and (select a.caixa'
      ...
      '                                from venctosdadosfiscais vdf'
        ...
        ')'
      '         limit 1)=:UsuarioCaixa'
      #9'and df.situacao = '#39'N'#39
      ''
      ''
      'order by df.data, df.nrdocumento desc'
      '')
    RequestLive = True
    Left = 64
    Top = 176
    ...
    object qryDadosFiscaistiponfe: TStringField
      FieldName = 'tiponfe'
      Size = 10
    end
    object qryDadosFiscaisoperacao: TStringField
      FieldName = 'operacao'
      Size = 10
    end
    ...
    object qryDadosFiscaisemissao: TDateField
      Alignment = taCenter
      FieldName = 'emissao'
    ...
    object qryDadosFiscaiscnpj: TStringField
      FieldName = 'cnpj'
      Size = 14
    end
    ...
    object qryDadosFiscaisvalornota: TFloatField
      FieldName = 'valornota'
      DisplayFormat = '0.00'
    end
    object qryDadosFiscaisselecionar: TBooleanField
      FieldName = 'selecionar'
    end
    object qryDadosFiscaischavenota: TIntegerField
      FieldName = 'chavenota'
    end
    ...
    object qryDadosFiscaislimiteminutos: TIntegerField
      FieldName = 'limiteminutos'
    end
    object qryDadosFiscaisMinRestantes: TStringField
