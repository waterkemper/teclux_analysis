unit fmChequeClienteFrenteCaixa;
...
type
  TfrmChequeClienteFrenteCaixa = class(TfrmCadastroPadrao)
...
var
  FrmChequeClienteFrenteCaixa: TfrmChequeClienteFrenteCaixa;
  origem : String;
...
constructor TfrmChequeClienteFrenteCaixa.Create(Aowner: TComponent);
begin
  Inherited;
...
procedure TfrmChequeClienteFrenteCaixa.edfCodigoClienteExit(Sender: TObject);
begin
  inherited;
...
procedure TfrmChequeClienteFrenteCaixa.fracgcoucpfedtCPFCNPJExit(Sender: TObject);
begin
  inherited;
...
procedure TfrmChequeClienteFrenteCaixa.fracgcoucpfrgbTipoPessoaChange(Sender: TObject);
begin
  inherited;
  fracgcoucpf.edtCPFCNPJ.Tipo := dtmFrenteCaixa.TipoPessoa;
...
procedure TfrmChequeClienteFrenteCaixa.KeyDown(var Key: Word; Shift: TShiftState);
begin
  inherited;
...
procedure TfrmChequeClienteFrenteCaixa.FormKeyDown(Sender: TObject;
...
{
procedure TfrmChequeClienteFrenteCaixa.bbnOKClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmChequeClienteFrenteCaixa.bbnCancelarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmChequeClienteFrenteCaixa.sbnProcurarClick(Sender: TObject);
begin
  inherited;
  ConsultaClientes.InternoPesquisar(ctCLIENTES);
  AbrirClientes;
...
procedure TfrmChequeClienteFrenteCaixa.fraEnderecoEditoredtCEPKeyPress(
...
procedure TfrmChequeClienteFrenteCaixa.fraEnderecoEditorsbnRuaClick(
  Sender: TObject);
begin
  inherited;
...
destructor TfrmChequeClienteFrenteCaixa.Destroy;
begin
  if Assigned(OntecClose) then
    OntecClose;
  inherited;
  frmChequeClienteFrenteCaixa:= nil;
end;


procedure TfrmChequeClienteFrenteCaixa.AbrirClientes;
begin
...
function TfrmChequeClienteFrenteCaixa.InternoIncluir: Boolean;
begin
  Result:= False;
  if not CtrlOn then
  begin
...
function TfrmChequeClienteFrenteCaixa.InternoGravar: Boolean;
begin
{
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        fraEnderecoEditor.edtCiade.DataSource.DataSet.FieldByName('nomecidade').AsString := dtmFrenteCaixa.CidadeFilialBase;
...
function TfrmChequeClienteFrenteCaixa.InternoExcluir: Boolean;
begin
  dtmFrenteCaixa.FechaClientes(True);
  close;
...
procedure TfrmChequeClienteFrenteCaixa.AlterarEstadoBotoes;
begin
  inherited;
...
procedure TfrmChequeClienteFrenteCaixa.FormShow(Sender: TObject);
begin
  inherited;
  sbnProcurar.enabled := true;
end;

procedure TfrmChequeClienteFrenteCaixa.FormClose(Sender: TObject;
...
procedure TfrmChequeClienteFrenteCaixa.edfCodigoClienteEnter(Sender: TObject);
begin
  inherited;
...
procedure TfrmChequeClienteFrenteCaixa.FormCloseQuery(Sender: TObject;
  var CanClose: Boolean);
begin
  inherited;
  {
  Canclose := true;
  if parsistema.ObrigaChequeClienteFrenteCaixa then
    Canclose := dtmfrentecaixa.clientevenda<>0;
    }
end;

procedure TfrmChequeClienteFrenteCaixa.edfCodigoClienteKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  inherited;
...
procedure TfrmChequeClienteFrenteCaixa.fraCMC7edtCMC7Exit(Sender: TObject);
begin
  inherited;
...
procedure TfrmChequeClienteFrenteCaixa.fraCMC7edtManual1Exit(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmChequeClienteFrenteCaixa.fraCMC7edtManual2Exit(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmChequeClienteFrenteCaixa.fraCMC7edtManual3Exit(
  Sender: TObject);
begin
  inherited;
