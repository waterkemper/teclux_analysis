...
uses  dmGerarRemessas, dmbasico, fmconfirmarimpressaonoboleto, DateUtils;
   ...
   begin
     ...
     begin
       ...
       begin
         ...
         if qryContasBanco.AsInteger = 341 then {Itaú}   {Itaú não pode ter mais que 8 caracteres}
...
//                                                                 inttostr(DayOfTheYear( strtodate(edtDiaMes.Text+'/'+inttostr(YearOf(Now)))))
