inherited frmlerretornos: Tfrmlerretornos
  ...
  inherited pnlTopMenu: TPanel
    ...
    inherited tblBarraCadastro: TToolBar
      ...
      object sbnAtualizarParcelas: TSpeedButton
        Left = 0
        Top = 2
        Width = 75
        Height = 39
        ...
        NumGlyphs = 2
        Spacing = 0
        OnClick = sbnAtualizarParcelasClick
      end
    end
  end
  object plnFundoJanela: TPanel
    ...
    object pnlParametros: TPanel
      ...
      object gbxConta: TGroupBox
        ...
        object edfConta: TtecDbEditFind
          ...
          DataField = 'Conta'
          DataSource = dtmLerRetornos.dsrContas
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'Helvetica'
      ...
      object gbxNomeArquivo: TGroupBox
        ...
        Width = 830
        Height = 36
        Caption = ' NOME DA PASTA\ARQUIVO DE RETORNO '
      ...
      object gbxFilial: TGroupBox
        ...
        object edfFiliais: TtecDbEditFind
          ...
          AutoSize = False
          DataField = 'codigo'
          DataSource = dtmLerRetornos.dsrFiliais
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
    ...
    object gbxTotais: TGroupBox
      ...
      Align = alBottom
      TabOrder = 1
      object edtTotalPagto: TDBEditNumero
        Left = 888
        Top = 9
        Width = 89
        Height = 24
        ...
        Negativo = False
        Tamanho = 9
        DataField = 'TotalPagto'
        DataSource = dtmLerRetornos.dsrcdsParcelas
      end
      object lblTotalPagto: TStaticText
        Left = 818
        Top = 13
        Width = 70
        Height = 20
      ...
      object edtTotalVencto: TDBEditNumero
        Left = 714
        Top = 9
        Width = 89
        Height = 24
        ...
        Negativo = False
        Tamanho = 9
        DataField = 'Totalvencto'
        DataSource = dtmLerRetornos.dsrcdsParcelas
      end
      object lblTotalVencto: TStaticText
        Left = 636
        Top = 13
        Width = 77
        Height = 20
        Caption = 'Total Vencto'
        TabOrder = 3
      end
      ...
      object edtTotalRecebidoBoleto: TDBEditNumero
        Left = 203
        Top = 9
        Width = 89
        Height = 24
        ...
        Negativo = False
        Tamanho = 9
        DataField = 'TotalRecebidoBoleto'
        DataSource = dtmLerRetornos.dsrcdsParcelas
      end
    end
    object pgcRetornos: TtecPageControl
      Left = 3
      Top = 97
      Width = 1225
      Height = 477
      ...
      Align = alClient
      TabOrder = 2
      OnChange = pgcRetornosChange
      object tstParcelas: TTabSheet
        Caption = 'Parcelas Retornadas'
        object dbgParcelas: TtecDBGrid
          ...
          Height = 433
          Align = alClient
          DataSource = dtmLerRetornos.dsrParcelas
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
        ...
        object pnlCabecalhoParcelasRetornadas: TPanel
          Left = 0
          Top = 0
          Width = 1217
          Height = 13
      ...
      object tstLogRetornos: TTabSheet
        Caption = 'Log'
        ImageIndex = 1
        object DBAdvretorno_cobranca: TDBAdvGrid
          Left = 0
          Top = 41
          Width = 1217
          Height = 144
          ...
          DataSource = dtmLerRetornos.dsrretorno_cobranca
          EditPostMode = epRow
          InvalidPicture.Data = {
        ...
        object DBAdvretorno_cobranca_titulo: TDBAdvGrid
          Left = 0
          Top = 185
          Width = 1217
          Height = 261
          ...
          ScrollBars = ssBoth
          TabOrder = 1
          OnResize = DBAdvretorno_cobranca_tituloResize
          OnColumnSizing = DBAdvretorno_cobranca_tituloColumnSizing
          OnRowSizing = DBAdvretorno_cobranca_tituloRowSizing
          ActiveCellFont.Charset = DEFAULT_CHARSET
          ActiveCellFont.Color = clWindowText
          ActiveCellFont.Height = -11
          ActiveCellFont.Name = 'Tahoma'
          ...
          DataSource = dtmLerRetornos.dsrretorno_cobranca_titulo
          EditPostMode = epRow
          InvalidPicture.Data = {
            055449636F6E0000010001002020040000000000E80200001600000028000000
            2000000040000000010004000000000000020000000000000000000000000000
        ...
        object pnlParametrosLog: TPanel
          Left = 0
          Top = 0
          Width = 1217
          Height = 41
          ...
          object gbxNumerodoContrato: TGroupBox
            Left = 183
            Top = 2
            Width = 138
            Height = 36
            ...
            ParentFont = False
            TabOrder = 1
            object edtNrContrato: TEditTexto
              Left = 4
              Top = 11
              Width = 130
              Height = 23
  ...
  object dlgLerRetornos: TOpenDialog
    Filter = 
  ...
  object AdvGridFindDialog_C_BT: TAdvGridFindDialog
    AutoPosition = False
    Grid = DBAdvretorno_cobranca_titulo
  ...
  object AdvGridFindDialog_C_B: TAdvGridFindDialog
    AutoPosition = False
    Grid = DBAdvretorno_cobranca
    MsgNotFound = 'O texto n'#227'o pode ser encontrado'
    MsgNoMoreFound = 'N'#227'o h'#225' mais ocorr'#234'ncias do texto'
    TxtCaption = 'Pesquisa'
    TxtTextToFind = 'Texto a procurar'
    ...
    TxtBtnOk = 'Ok'
    TxtBtnCancel = 'Cancela'
    OnCellFound = AdvGridFindDialog_C_BCellFound
    OnFindDone = AdvGridFindDialog_C_BFindDone
    OnFindClose = AdvGridFindDialog_C_BFindClose
    OnDialogKeyDown = AdvGridFindDialog_C_BDialogKeyDown
    Left = 678
    Top = 278
  end
  object AdvGridExcelIO1: TAdvGridExcelIO
    AdvStringGrid = DBAdvretorno_cobranca_titulo
