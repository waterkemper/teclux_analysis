...
var
  ...
  TipoPesquisa: TtecGerarRemessasPagamentos;
   ...
   begin
     ...
     begin
       ...
       begin
         ...
         edmNumero.text := copy(preencheString(inttostr(dtmGerarRemessasPagamentos.qryContasSequencial.asinteger), '0',4,false),3,2) ;
...
begin
   ...
   try
     ...
     result_sbnGerarParcelas := dtmGerarRemessasPagamentos.qryParcelas.recordcount <> 0;
...
begin
   ...
   then if frmConfirmarImpressaonoboleto.ckbImprimirRelatorio.Checked
        then dtmGerarRemessasPagamentos.imprimirEspelhoRemessa
        else if frmConfirmarImpressaonoboleto.ckbImprimirBoleto.Checked then begin
                 if dtmGerarRemessasPagamentos.qryContasNrViasBoleto.AsInteger = 0
                 then MensagemErro('O nº de vias do boleto é "0" (zero).')
                 else dtmGerarRemessasPagamentos.ImprimirBoleto;
             end;
end;
