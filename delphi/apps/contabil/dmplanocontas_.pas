...
uses
  SysUtils, Types, Classes, Variants, Controls, Forms, Dialogs, DB, {Qete,}
  fmpreviewpadrao,
  //Terceiros
  ZQuery, ZPgSqlQuery,
  //Componentes
...
begin
  inherited;
  if field = qryPlanoContasnatureza then
    if (qryPlanoContasnatureza.AsString<>'') then
      if qryplanocontas.State in [dsedit,dsinsert] then
...
begin
  ...
  begin
    ...
    qryAtualizarNaturezas.ParamByName('classificacao').AsString := qryPlanoContasclassificacao.AsString;
