...
procedure Tdtmcomissaovendedorespagtoparcelas.DefineOrdenacao;
var
Ordenacao : String;
begin
  Ordenacao:='';
...
procedure Tdtmcomissaovendedorespagtoparcelas.frpRecebimentosPISCOFINSBeforePrint(
...
procedure Tdtmcomissaovendedorespagtoparcelas.ZMonitorMonitorEvent(Sql,
  Result: String);
var
 Listar : TStringList;
 FileName: String;
...
procedure Tdtmcomissaovendedorespagtoparcelas.qryRecebimentosCalcFields(
  DataSet: TDataSet);
begin
  inherited;
...
procedure Tdtmcomissaovendedorespagtoparcelas.MontaIntervaloPeriodoEmissao;
begin
...
procedure Tdtmcomissaovendedorespagtoparcelas.MontaIntervaloPeriodoVencimento;
begin
...
procedure Tdtmcomissaovendedorespagtoparcelas.SetVisualizarValoresPISeCOFINS(
  const Value: Boolean);
begin
...
procedure Tdtmcomissaovendedorespagtoparcelas.frpRecebimentosBeforePrint(
  Memo: TStringList; View: TfrView);
begin
  inherited;
...
procedure Tdtmcomissaovendedorespagtoparcelas.frpRecebimentos_resumo_BeforePrint(
  Memo: TStringList; View: TfrView);
begin
  inherited;
...
procedure Tdtmcomissaovendedorespagtoparcelas.frpRecebimentosPISCOFINS_resumo_BeforePrint(
  Memo: TStringList; View: TfrView);
begin
  inherited;
...
procedure Tdtmcomissaovendedorespagtoparcelas.frpRecebimentosPISCOFINSBeginBand(
  Band: TfrBand);
begin
  inherited;
...
procedure Tdtmcomissaovendedorespagtoparcelas.frpRecebimentosBeginBand(
  Band: TfrBand);
begin
  inherited;
...
procedure Tdtmcomissaovendedorespagtoparcelas.frpRecebimentos_resumoBeforePrint(
  Memo: TStringList; View: TfrView);
begin
  inherited;
  ZebrarLinhaRelatorio(frpRecebimentos_resumo,View);
...
procedure Tdtmcomissaovendedorespagtoparcelas.frpRecebimentosPISCOFINS_resumoBeforePrint(
  Memo: TStringList; View: TfrView);
begin
  inherited;
  ZebrarLinhaRelatorio(frpRecebimentosPISCOFINS_resumo,View);
...
procedure Tdtmcomissaovendedorespagtoparcelas.frpRecebimentosEndBand(
  Band: TfrBand);
begin
  inherited;
  if Band.Name = 'RodapeMestre' then
...
procedure Tdtmcomissaovendedorespagtoparcelas.SetFilialExibicao(
  const Value: Integer);
begin
  FFilialExibicao := Value;
end;

procedure Tdtmcomissaovendedorespagtoparcelas.SetFilialSelecao(
  const Value: Integer);
begin
