inherited frmrelatoriocontasareceber: Tfrmrelatoriocontasareceber
  Left = 461
  Top = 90
  ...
  inherited pnlFundoJanela: TPanel
    ...
    object gbxAgrupamento: TGroupBox
      ...
      object ckbAgruparData: TCheckBox
        Left = 6
        Top = 91
        Width = 110
        Height = 18
    ...
    object pgcFilialGrupoFilial: TtecPageControl
      ...
      object tstGrupoFilial: TTabSheet
        ...
        ImageIndex = 1
        inline fraConsultaGrupoFilial: TfraConsultaCodigo
          Left = 2
          Top = 2
          Width = 533
          Height = 25
          ...
          inherited dtxDescricao: TtecDBText
            Width = 445
            DataField = 'descricao'
            DataSource = fraConsultaGrupoFilial.dsrProcuraGrupoFiliais
          end
          inherited edfCodigo: TtecDBFindLookup
            DataField = 'codigo'
            DataSource = fraConsultaGrupoFilial.dsrProcuraGrupoFiliais
    ...
    object cbkVisualizarValoresPISeCOFINS: TCheckBox
      Left = 498
      Top = 402
      Width = 225
      Height = 20
      Caption = 'Visualizar valores do PIS e COFINS'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -12
      Font.Name = 'helvetica'
    ...
    object stxTipoRelatorio: TStaticText
      Left = 16
      Top = 14
      Width = 103
      Height = 16
      Caption = ' TIPO DE RELAT'#211'RIO '
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -9
      Font.Name = 'helvetica'
