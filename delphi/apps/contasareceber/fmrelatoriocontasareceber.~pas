...
function Tfrmrelatoriocontasareceber.ValidarCamposSelecao: Boolean;
begin
...
procedure Tfrmrelatoriocontasareceber.rgbTipoRelatorioClick(
  Sender: TObject);
begin
  inherited;
...
procedure Tfrmrelatoriocontasareceber.FormActivate(Sender: TObject);
begin
  inherited;
  rgpFilialSelecao.visible :=   rgbTipoRelatorio.itemindex = 1;
  rgpFilialExibicao.visible :=  rgbTipoRelatorio.itemindex = 1;
