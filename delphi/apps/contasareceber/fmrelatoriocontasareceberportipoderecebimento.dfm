inherited frmrelatoriocontasareceberportipoderecebimento: Tfrmrelatoriocontasareceberportipoderecebimento
  Left = 464
  Top = 200
  ActiveControl = edtDataInicialVencto
  Caption = 'Relat'#243'rio de Contas a Receber por Tipo de Recebimento'
  ClientHeight = 499
  ClientWidth = 1053
  ...
  inherited pnlFundoJanela: TPanel
    ...
    object gbxEmissao: TGroupBox
      ...
      object edtDataInicialEmissao: TEditData
        ...
        ParentFont = False
        TabOrder = 0
        OnExit = edtDataInicialEmissaoExit
        Minimo = 37353
        Maximo = 37353
      end
    ...
    object gbxAgrupamento: TGroupBox
      ...
      object ckbAgruparDataVencimento: TCheckBox
        Left = 8
        Top = 114
        Width = 138
        Height = 18
      ...
      object ckbAgruparTipoRecebimento: TCheckBox
        Left = 8
        Top = 80
        Width = 138
        Height = 18
      ...
      object ckbAgruparFormadeRecebimento: TCheckBox
        Left = 8
        Top = 63
        Width = 161
        Height = 18
      ...
      object ckbAgruparDataEmissao: TCheckBox
        Left = 8
        Top = 98
        Width = 138
        Height = 18
    ...
    inline fraOrdenacao1: TfraOrdenacao
      ...
      inherited gbxOrdenacao: TGroupBox
        ...
        inherited pnlDireito: TPanel
          ...
          Top = 16
          Height = 175
          inherited sbnAcima: TSpeedButton
            Top = 1
          end
          inherited sbnAbaixo: TSpeedButton
            Top = 25
          end
        end
      ...
      inherited qryLista: TtecQuery
        Sql.Strings = (
          'select cast('#39'Data Vencto'#39' as varchar(50)) as CAMPODESCRICAO,'
          '           cast('#39'datavencto'#39' as varchar(50)) as CAMPO,'
          '          cast('#39'Asc'#39' as varchar) as TIPO'
          'UNION ALL'
          
            'select cast('#39'Nome do cliente'#39' as varchar(50)) as CAMPODESCRICAO,' +
            ' '
          '           cast('#39'nomecliente'#39' as varchar(50)) as CAMPO,'
          '          cast('#39'Asc'#39' as varchar) as TIPO')
      end
    end
    ...
    object gbxFormasRecebimento: TGroupBox
      Left = 489
      Top = 88
      Width = 144
      Height = 137
    ...
    object gbxDuplicatas: TGroupBox
      ...
      object ckbAReceber: TCheckBox
        ...
        State = cbChecked
        TabOrder = 0
        OnClick = ckbAReceberClick
      end
      object ckbRecebidos: TCheckBox
        Left = 55
        Top = 30
        Width = 80
        Height = 18
        ...
        State = cbChecked
        TabOrder = 1
        OnClick = ckbRecebidosClick
      end
      object cbbaReceber_e_ou_Recebidos: TComboBox
        Left = 8
        Top = 19
        Width = 40
        Height = 23
    ...
    inline fraListaCargosouAtividades1: TfraListaCargosouAtividades
      Left = 322
      Top = 231
      Width = 303
      Height = 195
      ...
      inherited gbx: TGroupBox
        ...
        inherited clblista: TCheckListBox
          Top = 35
          Width = 273
          Height = 158
          Font.Color = clBlack
