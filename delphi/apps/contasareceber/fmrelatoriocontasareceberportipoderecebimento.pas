...
uses
  ...
  frordenacao, ToolWin, frlistacargosouatividades;
...
type
  Tfrmrelatoriocontasareceberportipoderecebimento = class(TfrmRelatorioPadrao)
    ...
    ckbAgruparDataVencimento: TCheckBox;
...
begin
  ...
  fraListaFiliais1.clbFiliais.Font.Height:= -12;

  fraListaTiposdeRecebimentos1.gbx.Font.Height:= -11;
...
begin
  ...
  begin
    ...
    begin
      ParametroCabecalho:= '';
      VisualizarValoresPISeCOFINS := false;
      ...
      Recebidos := ckbRecebidos.Checked;
      aReceber := ckbAReceber.Checked;
      aReceber_e_ou_Recebido := cbbaReceber_e_ou_Recebidos.itemindex;
      ...
      AgruparFormadeRecebimento := ckbAgruparFormadeRecebimento.Checked;
      AgruparTipodeRecebimento := ckbAgruparTipoRecebimento.Checked;
      AgruparDataEmissao := ckbAgruparDataEmissao.Checked;

      AgruparData := ckbAgruparDataVencimento.Checked;
...
procedure Tfrmrelatoriocontasareceberportipoderecebimento.ckbAReceberClick(
  Sender: TObject);
begin
  inherited;
  if not ckbAReceber.Checked then
    ckbRecebidos.Checked := true;

//  gbxVencimentos.visible := ckbAReceber.checked;

end;

procedure Tfrmrelatoriocontasareceberportipoderecebimento.ckbRecebidosClick(
  Sender: TObject);
begin
  inherited;
  if not ckbRecebidos.Checked then
    ckbAReceber.Checked := true;

  gbxDataRecebimentos.visible := ckbRecebidos.Checked;
