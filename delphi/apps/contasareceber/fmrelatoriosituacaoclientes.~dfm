inherited frmRelatorioSituacaoClientes: TfrmRelatorioSituacaoClientes
  Left = 449
  Top = 209
  ActiveControl = edtDataInicial
  Caption = 'Relat'#243'rio de Situa'#231#227'o dos Clientes'
  ClientHeight = 322
  ClientWidth = 723
  ...
  object gbxOpcoes: TGroupBox
    ...
    object ckbQuebraporCliente: TCheckBox
      Left = 7
      Top = 31
      Width = 210
      Height = 19
      Caption = 'Quebrar p'#225'gina por cliente'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -12
      Font.Name = 'helvetica'
    ...
    object ckbNao_incluir_duplicatas_estornadas: TCheckBox
      Left = 7
      Top = 51
      Width = 210
      Height = 19
      Caption = 'N'#227'o incluir duplicatas estornadas'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -12
      Font.Name = 'helvetica'
  ...
  inline fraListaSeriesFiliais1: TfraListaSeriesFiliais
    Left = 225
    Top = 148
    Width = 136
    Height = 171
    ...
    inherited gbx: TGroupBox
      ...
      inherited clbSeriesFiliais: TCheckListBox
        Top = 20
        Width = 106
        Height = 149
        Font.Height = -12
  ...
  object stxPesquisar: TStaticText
    Left = 237
    Top = 47
    Width = 58
    Height = 16
  ...
  object stxSituacaoEm: TStaticText
    Left = 317
    Top = 58
    Width = 4
    Height = 4
  ...
  object stxSituacao: TStaticText
    Left = 325
    Top = 47
    Width = 53
    Height = 16
