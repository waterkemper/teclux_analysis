...
type
  ...
  TdtmContasPagar = class(TdtmBasico)
    ...
    qryDuplicatasduplicatapaga: TBooleanField;
  ...
  begin
    ...
    begin
      ...
      if qryDuplicatasdatapagto.AsDateTime = 0 then begin
        ...
        qryDuplicatasvalorpagto.AsCurrency := ValorPagar;
...
begin
  ...
  try
    ...
    RegistroAtual := qryDuplicatas.GetBookmark;
    qryDuplicatas.First;
    ...
    qryDuplicatas.EnableControls;
    qryDuplicatas.GotoBookmark(RegistroAtual);
    qryDuplicatas.FreeBookmark(RegistroAtual);
...
function TdtmContasPagar.ValorPagar: Currency;
var
 Multa,Juros: Real;
 NrDias: Integer;
...
begin
 ...
 if qryDuplicatasdatavencto.isnull then
   ...
   vDataVencto := PrimeiroDiaUtil_(qryDocumentosPagfilialemissao.AsInteger, qryDuplicatasdatavencto.AsDateTime, 'P');
