inherited frmConfirmarRomaneiosSaida: TfrmConfirmarRomaneiosSaida
  Left = 231
  Top = 151
  Caption = 'Confirma'#231#227'o de Romaneios de Sa'#237'da'
  ClientHeight = 523
  ClientWidth = 1250
  ...
  object gbxPesquisaNFe: TGroupBox
    ...
    Height = 41
    Align = alTop
    Caption = 'Pesquisar CHAVE NFE/LOTES'
    TabOrder = 2
  ...
  object dbgRomaneiosNotasSaidas: TDBAdvGrid
    Left = 0
    Top = 86
    Width = 1250
    Height = 436
    ...
    ScrollBars = ssBoth
    TabOrder = 3
    OnCanClickCell = dbgRomaneiosNotasSaidasCanClickCell
    ...
    DataSource = dtmConfirmarRomaneiosSaida.dsrRomaneiosNotasSaidas
    InvalidPicture.Data = {
