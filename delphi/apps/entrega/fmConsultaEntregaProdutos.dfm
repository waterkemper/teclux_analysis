inherited frmConsultaEntregaProdutos: TfrmConsultaEntregaProdutos
  Left = 310
  Top = 34
  Caption = 'Agendamento de entregas'
  ClientHeight = 585
  ClientWidth = 678
  ...
  object pgcConsultaEntregaProdutos: TPageControl
    Left = 0
    Top = 45
    Width = 678
    Height = 540
    ...
    Align = alClient
    TabOrder = 0
    OnChanging = pgcConsultaEntregaProdutosChanging
    object tstParametros: TTabSheet
      ...
      inline fraListaFiliaisVenda: TfraListaFiliais
        Left = 8
        Top = 143
        Width = 313
        Height = 226
        ...
        inherited gbxFiliais: TGroupBox
          ...
          inherited sbnDesmarcarFiliais: TSpeedButton
            Left = 284
            Width = 23
            OnClick = fraListaFiliaisVendasbnDesmarcarFiliaisClick
          end
      ...
      object gbxPeriodo: TGroupBox
        ...
        object DBAdvGrid1: TDBAdvGrid
          ...
          DataSource = dtmConsultaEntregaProdutos.dsrPeriodosEntrega
          InvalidPicture.Data = {
      ...
      object ckbTodoIntervaloEntregas: TCheckBox
        Left = 176
        Top = 24
        Width = 113
        Height = 17
        Caption = 'Todas as entregas'
        TabOrder = 1
      end
      inline fraListaFiliaisProduto: TfraListaFiliais
        Left = 339
        Top = 143
        Width = 327
        Height = 226
    ...
    object tstDados: TTabSheet
      Caption = 'Dados'
      ImageIndex = 1
      object dbgConsultaEntregaProdutos: TDBAdvGrid
        Left = 0
        Top = 0
        Width = 670
        Height = 512
        ...
        ScrollBars = ssBoth
        TabOrder = 0
        OnDblClick = dbgConsultaEntregaProdutosDblClick
        OnGetDisplText = dbgConsultaEntregaProdutosGetDisplText
        OnColumnCalc = dbgConsultaEntregaProdutosColumnCalc
        OnGroupCalc = dbgConsultaEntregaProdutosGroupCalc
        OnCanSort = dbgConsultaEntregaProdutosCanSort
        OnGetEditorType = dbgConsultaEntregaProdutosGetEditorType
        OnGetFloatFormat = dbgConsultaEntregaProdutosGetFloatFormat
        ActiveCellShow = True
        ActiveCellFont.Charset = DEFAULT_CHARSET
        ActiveCellFont.Color = clWindowText
        ActiveCellFont.Height = -11
        ...
        FixedFont.Style = [fsBold]
        FloatFormat = '%.2f'
        Grouping.HeaderTextColor = 8404992
        ...
        DataSource = dtmConsultaEntregaProdutos.dsrConsultaEntregaProdutos
        PageMode = False
        InvalidPicture.Data = {
          055449636F6E0000010001002020040000000000E80200001600000028000000
          2000000040000000010004000000000000020000000000000000000000000000
  ...
  object AdvDBDateTimePicker1: TAdvDBDateTimePicker
    ...
    Width = 90
    Height = 21
    Date = 44783.387152777780000000
    Time = 44783.387152777780000000
    Kind = dkDate
    TabOrder = 3
    Visible = False
    AutoTab = True
    ...
    Ctl3D = True
    DateTime = 44783.387152777780000000
    TimeFormat = 'HH:mm'
    Version = '1.2.0.1'
  ...
  object AdvDBLookupComboBox1: TAdvDBLookupComboBox
    ...
    DropFont.Style = []
    KeyField = 'codigo'
    ListSource = dtmConsultaEntregaProdutos.dsrPeriodosEntrega
    ReturnIsTab = True
    SortUpGlyph.Data = {
