inherited frmSelecaoMultiplasNotasRomaneio: TfrmSelecaoMultiplasNotasRomaneio
  Left = 173
  Top = 107
  BorderIcons = [biSystemMenu, biMinimize, biMaximize]
  Caption = 'Sele'#231#227'o de Notas para o Romaneio'
  ClientHeight = 521
  ClientWidth = 1163
  ...
  object pgcConsultaNotaseCupons: TPageControl
    Left = 0
    Top = 45
    Width = 1163
    Height = 476
    ...
    object tstParametros: TTabSheet
      ...
      object gbxEntregaEntre: TGroupBox
        Left = 170
        Top = 6
        Width = 160
        Height = 36
        ...
        object edtDataInicialEntrega: TEditData
          Left = 2
          Top = 10
          Width = 70
          Height = 23
        ...
        object edtDataFinalEntrega: TEditData
          Left = 87
          Top = 10
          Width = 70
          Height = 23
    ...
    object tstDados: TTabSheet
      ...
      object gbxNotasFiscais: TGroupBox
        ...
        ParentFont = False
        TabOrder = 0
        object dbgNotasFiscais: TDBAdvGrid
          Left = 2
          Top = 16
          Width = 1151
          Height = 323
          ...
          TabOrder = 0
          ActiveRowShow = True
          OnCanSort = dbgNotasFiscaisCanSort
          OnClipboardPaste = dbgNotasFiscaisClipboardPaste
          OnClipboardCut = dbgNotasFiscaisClipboardCut
          ActiveCellShow = True
          ...
          Columns = <
            ...
            item
              ...
              Font.Pitch = fpVariable
              Font.Style = []
              Header = 'Nome Filial Emiss'#227'o'
              HeaderFont.Charset = DEFAULT_CHARSET
              HeaderFont.Color = clBlack
              HeaderFont.Height = -9
              HeaderFont.Name = 'Helvetica'
          ...
          DataSource = dtmCadastroRomaneios.dsrNotasRomaneio
      ...
      object gbxValoresPadrao: TGroupBox
        Left = 0
        Top = 341
        Width = 1155
        Height = 105
        Align = alBottom
        Caption = ' VALORES PADR'#195'O '
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'HELVETICA'
        ...
        object sbnAplicar: TSpeedButton
          ...
          Width = 102
          Height = 39
          Hint = 'Aplica aos registros marcados os valores padr'#227'o'
          Constraints.MaxHeight = 39
          Constraints.MinHeight = 39
          Caption = 'Aplicar Ctrl+F5'
          Flat = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
        ...
        object cbbTipodeFrete: TTecDBLookupComboBox
          Left = 320
          Top = 56
          Width = 193
          Height = 22
          ...
          DataSource = dtmCadastroRomaneios.dsrNotasRomaneio
          KeyField = 'codigo'
          ListField = 'codigodescricaofrete'
          ListSource = dtmCadastroRomaneios.dsrTabeladeFretes
          NullValueKey = 46
          TabOrder = 5
        end
        object gbxTipodeFrete: TGroupBox
          Left = 8
          Top = 16
          Width = 205
          Height = 36
          ...
          ParentFont = False
          TabOrder = 0
          object cbbTabeladeFrete: TLUCombo
            Left = 2
            Top = 12
            Width = 200
            Height = 20
            ...
            LabelFont.Style = []
            TabOrder = 0
            OnKeyDown = cbbTabeladeFreteKeyDown
            AutoHistory = False
            AutoHistoryLimit = 0
        ...
        object gbxDatadeEntrega: TGroupBox
          Left = 8
          Top = 56
          Width = 95
          Height = 36
          ...
          ParentFont = False
          TabOrder = 1
          object edtDataEntrega: TAdvSmoothDatePicker
            Left = 2
            Top = 10
            Width = 87
            Height = 23
