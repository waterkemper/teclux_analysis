inherited dtmAnaliseestoques: TdtmAnaliseestoques
  ...
  object qryAnaliseEstoques: TtecQuery
    ...
    object qryAnaliseEstoquesreferencia: TStringField
      DisplayLabel = 'REFERENCIA'
      DisplayWidth = 20
      FieldName = 'referencia'
      Size = 30
    end
    object qryAnaliseEstoquesvalorgrade1: TStringField
      DisplayLabel = 'VALORGRADE1'
      DisplayWidth = 30
      FieldName = 'valorgrade1'
      Size = 50
    end
    object qryAnaliseEstoquesvalorgrade2: TStringField
      DisplayLabel = 'VALORGRADE2'
      DisplayWidth = 30
