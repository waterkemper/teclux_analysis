inherited frmAlteracoesPrecos: TfrmAlteracoesPrecos
  Left = 387
  Top = 64
  ...
  inherited pnlBarra: TToolBar
    ...
    object sbnGerar: TSpeedButton
      ...
      Width = 70
      Height = 39
      Hint = 'Gerar Consulta de compras'
      Constraints.MinHeight = 36
      Caption = 'Gerar F6'
      Flat = True
      Glyph.Data = {
    ...
    object sbnManutencaoPreco: TSpeedButton
      Left = 393
      Top = 2
      Width = 127
      Height = 39
      Hint = 'Abrir a Tela de manuten'#231#227'o de pre'#231'o'
      ...
      Glyph.Data = {
        ...
        DCDCDCDCDCDCDCDCDCDCDCDCDC00}
      Layout = blGlyphTop
      OnClick = sbnManutencaoPrecoClick
    end
  end
  ...
  object pgcAlteracoesPrecos: TPageControl
    Left = 0
    Top = 43
    Width = 1077
    Height = 549
    ...
    object tstParametros: TTabSheet
      ...
      object lblMargem: TStaticText
        Left = 176
        Top = 14
        Width = 139
        Height = 17
        Caption = 'Margem de Lucro abaixo de '
        TabOrder = 9
      end
      object edtMargemLucro: TEditNumero
        Left = 320
        Top = 8
        Width = 57
        Height = 21
      ...
      object pgcMultiplasSelecoes: TPageControl
        ...
        object tstListadeNotasFiscais: TTabSheet
          Caption = 'NOTAS FISCAIS DE ENTRADA'
          ImageIndex = 2
          inline fraSelecaoAleatorianotas1: TfraSelecaoAleatorianotas
            Left = 0
            Top = 0
            Width = 1057
            Height = 308
            Align = alClient
            TabOrder = 0
            inherited fraSelecaoAleatorianotas: TfraSelecaoAleatoria
              Width = 1057
              Height = 261
              inherited Splitter1: TSplitter
                Left = 937
      ...
      object gbxMovimentacao: TGroupBox
        ...
        object gbxTipodeMovimentacao: TGroupBox
          Left = 4
          Top = 52
          Width = 489
          Height = 36
          ...
          ParentFont = False
          TabOrder = 1
          inline fraConsultaTipoMovimentacao: TfraConsultaCodigo
            Left = 3
            Top = 10
            Width = 498
            Height = 24
            ...
            inherited dtxDescricao: TtecDBText
              ...
              Top = 1
              DataField = 'descricao'
              DataSource = fraConsultaTipoMovimentacao.dsrProcuraTipoMovimentos
            end
            inherited edfCodigo: TtecDBFindLookup
              Left = -1
              Top = 1
              ...
              DataField = 'codigo'
              DataSource = fraConsultaTipoMovimentacao.dsrProcuraTipoMovimentos
              Group = 'TipodeMovimentacaodeEstoque'
              MaxLength = 4
              OnFound = nil
              Operacao = opPESQUISA
              Parameter = 'codigo'
      ...
      object edtVariancaoPrecoAtualeAnteior: TEditNumero
        Left = 464
        Top = 8
        Width = 57
        Height = 21
      ...
      object ComboComparisonOperator: TComboBox
        Left = 549
        Top = 8
        Width = 45
        Height = 21
      ...
      object ckbSomentePrecoNormal: TCheckBox
        Left = 307
        Top = 411
        Width = 150
        Height = 17
        Caption = 'Somente Pre'#231'o Normal'
        Checked = True
        State = cbChecked
        TabOrder = 4
      end
    ...
    object tstDados: TTabSheet
      ...
      object pnlAlteracoesPrecosVP: TPanel
        Left = 713
        Top = 0
        Width = 356
        Height = 521
        ...
        BevelOuter = bvNone
        TabOrder = 0
        object dbgAlteracoesPrecosVP: TDBAdvGrid
          Left = 0
          Top = 0
          Width = 356
          Height = 203
          ...
          TabOrder = 0
          ActiveRowShow = True
          OnGetCellColor = dbgAlteracoesPrecosVPGetCellColor
          ActiveCellShow = True
          ...
          ActiveCellColor = 13224393
          AutoNumAlign = True
          Bands.PrimaryColor = clLime
          Bands.PrimaryLength = 10
          ...
          DataSource = dtmAlteracoesPrecos.dsrAlteracoesPrecosCargosVisaoParalela
          InvalidPicture.Data = {
          ...
          object Panel7: TPanel
            ...
            object gbxDadosUltimaCompra: TGroupBox
              ...
              object GroupBox5: TGroupBox
                ...
                object edtValorUltimacompra: TDBEditNumero
                  ...
                  DataSource = dtmAlteracoesPrecos.dsrConsultaEstoques
                end
              end
              ...
              object gbxSitTributariaNFnaEmpresa: TGroupBox
                ...
                Width = 113
                Height = 52
                Caption = 'Incid'#234'ncia Empresa'
                Font.Charset = DEFAULT_CHARSET
                Font.Color = clBlack
                Font.Height = -11
                Font.Name = 'helvetica'
            ...
            object gbxPrecos: TGroupBox
              ...
              object dtxValorNormal: TtecDBText
                ...
                DataSource = dtmAlteracoesPrecos.dsrPrecos
                Font.Charset = DEFAULT_CHARSET
                Font.Color = clBlack
                Font.Height = -13
                Font.Name = 'helvetica'
      ...
      object dbgAlteracoesPrecos: TDBAdvGrid
        Left = 0
        Top = 0
        Width = 709
        Height = 521
        ...
        ScrollBars = ssBoth
        TabOrder = 1
        OnSelectCell = dbgAlteracoesPrecosSelectCell
        ActiveRowShow = True
        GridFixedLineColor = clSilver
        OnGetCellColor = dbgAlteracoesPrecosGetCellColor
        OnGetColumnFilter = dbgAlteracoesPrecosGetColumnFilter
        OnCellChanging = dbgAlteracoesPrecosCellChanging
        OnClickCell = dbgAlteracoesPrecosClickCell
        OnCanClickCell = dbgAlteracoesPrecosCanClickCell
        ActiveCellShow = True
        ActiveCellFont.Charset = DEFAULT_CHARSET
        ActiveCellFont.Color = clWindowText
        ActiveCellFont.Height = -11
        ...
        ControlLook.FixedGradientHoverFrom = clSilver
        ControlLook.FixedGradientHoverTo = clSilver
        ControlLook.FixedGradientDownFrom = clGray
        ControlLook.FixedGradientDownTo = clSilver
        ControlLook.FixedGradientDownBorder = clSilver
        ControlLook.DropDownHeader.Font.Charset = DEFAULT_CHARSET
        ControlLook.DropDownHeader.Font.Color = clWindowText
        ControlLook.DropDownHeader.Font.Height = -11
        ControlLook.DropDownHeader.Font.Name = 'Tahoma'
        ...
        ControlLook.DropDownFooter.Visible = True
        ControlLook.DropDownFooter.Buttons = <>
        ControlLook.ProgressBorderColor = clSilver
        Filter = <>
        FilterDropDown.ColumnWidth = True
        FilterDropDown.Font.Charset = DEFAULT_CHARSET
        FilterDropDown.Font.Color = clWindowText
  ...
  object AdvGridExcelIO1: TAdvGridExcelIO
    AdvStringGrid = dbgAlteracoesPrecos
