object frmListaProdutosPendentesNF: TfrmListaProdutosPendentesNF
  Left = 137
  Top = 231
  Width = 1088
  Height = 563
  Caption = 'Produtos pendentes de emiss'#227'o de NF'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object dbgListaProdutosPendentesNF: TDBAdvGrid
    Left = 0
    Top = 0
    Width = 1072
    Height = 525
    ...
    DataSource = dtmConsultaCompras.dsrProdutosPendentes
    InvalidPicture.Data = {
