object frmListadePedidos: TfrmListadePedidos
  ...
  Width = 954
  Height = 545
  Caption = 'Lista de Pedidos entre Filiais'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object gbxListaRequisitante: TGroupBox
    Left = 0
    Top = 0
    Width = 938
    Height = 265
    Align = alTop
    Caption = 'Pedidos Requisitante'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
    ...
    ParentFont = False
    TabOrder = 0
    object dbgListaPedidosFiliaisRequisitante: TDBAdvGrid
      Left = 2
      Top = 15
      Width = 934
      Height = 248
      ...
      ScrollBars = ssBoth
      TabOrder = 0
      OnClick = dbgListaPedidosFiliaisRequisitanteClick
      ActiveRowShow = True
      ActiveCellShow = True
      ...
      DataSource = dtmConsultaCompras.dsrListaPedidosFiliais_Requisitante
      InvalidPicture.Data = {
      ...
      ColWidths = (
        ...
        143
        73)
      object pnlListaPedidosFiliaisRequisitante: TPanel
        Left = 904
        Top = 0
        Width = 26
        Height = 222
        ...
        DesignSize = (
          26
          222)
        object sbnCancelaFilialRequisitante: TSpeedButton
          Left = 0
          Top = 26
          Width = 26
          Height = 31
          Hint = 'Cancela o pedido da filial requisitante'
          AllowAllUp = True
          ...
          ParentFont = False
          Spacing = 0
          OnClick = sbnCancelaFilialRequisitanteClick
        end
      end
    end
  end
  object gbxListaRequisitado: TGroupBox
    Left = 0
    Top = 265
    Width = 938
    Height = 240
    Align = alTop
    Caption = 'Pedidos Requisitado'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
    ...
    ParentFont = False
    TabOrder = 1
    object dbgListaPedidosFiliaisRequisitado: TDBAdvGrid
      Left = 2
      Top = 15
      Width = 934
      Height = 223
      ...
      ScrollBars = ssBoth
      TabOrder = 0
      OnClick = dbgListaPedidosFiliaisRequisitadoClick
      ActiveRowShow = True
      ActiveCellShow = True
      ActiveCellFont.Charset = DEFAULT_CHARSET
      ActiveCellFont.Color = clWindowText
      ...
      DataSource = dtmConsultaCompras.dsrListaPedidosFiliais_Requisitado
      InvalidPicture.Data = {
        055449636F6E0000010001002020040000000000E80200001600000028000000
        2000000040000000010004000000000000020000000000000000000000000000
        0000000000000000000080000080000000808000800000008000800080800000
      ...
      ColWidths = (
        ...
        143
        73)
      object pnlListaPedidosFiliaisRequisitado: TPanel
        Left = 904
        Top = 0
        Width = 26
        Height = 197
        ...
        DesignSize = (
          26
          197)
        object sbnCancelaFilialRequisitada: TSpeedButton
          Left = 0
          Top = 26
          Width = 26
          Height = 31
          Hint = 'Cancela o pedido da filial requisitada'
          AllowAllUp = True
          Anchors = [akTop, akRight]
          Flat = True
          Font.Charset = DEFAULT_CHARSET
          ...
          ParentFont = False
          Spacing = 0
          OnClick = sbnCancelaFilialRequisitadaClick
        end
      end
    end
  end
