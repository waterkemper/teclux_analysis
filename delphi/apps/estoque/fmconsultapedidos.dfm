inherited frmConsultaPedidos: TfrmConsultaPedidos
  Left = 245
  Top = 92
  ...
  object pgcConsultaPedidos: TPageControl
    ...
    Align = alClient
    TabOrder = 3
    OnChange = pgcConsultaPedidosChange
    object tstParametros: TTabSheet
      Caption = 'Par'#226'metros'
      object pnlTopParametros: TPanel
        Left = 0
        Top = 0
        Width = 1153
        Height = 153
    ...
    object tstDados: TTabSheet
      ...
      object dbgPedidos: TtecDBGrid
        ...
        Height = 424
        Align = alClient
        DataSource = dtmConsultaPedidos.dsrPedidos
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        Font.Name = 'helvetica'
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'Filial de Entrega'
            Visible = True
          end
          item
            Expanded = False
      ...
      object pnlBottom: TPanel
        ...
        object DBText1: TDBText
          ...
          Color = 14211288
          DataField = 'Total'
          DataSource = dtmConsultaPedidos.tecDataSource1
        ...
        object gbxNotasEntrada: TGroupBox
          Left = 6
          Top = 4
          Width = 340
          Height = 20
        ...
        object dbgNotasPag: TtecDBGrid
          ...
          Width = 341
          Height = 138
          DataSource = dtmConsultaPedidos.dsrNotasPag
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -9
          Font.Name = 'helvetica'
        ...
        object gbxSituacoes: TGroupBox
          ...
          Width = 492
          Height = 45
          Caption = 'Situa'#231#245'es de pedido'
          TabOrder = 2
          ...
          object Label11: TLabel
            ...
            Width = 110
            Height = 16
            Caption = 'Parcial Li[Q]uidado'
            Color = clBtnFace
            ParentColor = False
          end
        end
        object sttTotal: TStaticText
          Left = 704
          Top = 8
          Width = 77
          Height = 20
