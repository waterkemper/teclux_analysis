inherited frmConsultaVendas: TfrmConsultaVendas
  ...
  inherited pnlBarra: TPanel
    ...
    object pgcConsultaVendas: TPageControl
      ...
      object tstParametros: TTabSheet
        ...
        object ckbIncluirServicos: TCheckBox
          Left = 6
          Top = 67
          Width = 123
          Height = 25
          Caption = 'Incluir Servi'#231'os'
          Checked = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
      ...
      object tstDados: TTabSheet
        Caption = 'Consulta'
        ImageIndex = 1
        object pgcGrade: TPageControl
          Left = 0
          Top = 0
          Width = 914
          Height = 615
          ActivePage = tstTotais
          Align = alClient
          TabOrder = 0
          object tstTotais: TTabSheet
            Caption = '&1 - Valores'
            object dbgVendasCliente_Dados: TtecDBGrid
              Left = 0
              Top = 0
              Width = 236
              Height = 540
              Align = alLeft
              DataSource = dtmConsultaVendas.dsrVendasCliente
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clBlack
              Font.Height = -10
              Font.Name = 'helvetica'
              ...
              TitleFont.Style = []
              OnDblClick = dbgVendasCliente_DadosDblClick
              OnTitleClick = dbgVendasCliente_DadosTitleClick
              RowWrap = 60
              Large = False
              DoubleRowColor = True
              TitleMinHeight = 100
              ...
              GridAssociado = dbgVendasCliente_Meses
            ...
            object dbgVendasCliente_Totais: TtecDBGrid
              Left = 805
              Top = 0
              Width = 101
              Height = 540
              ...
              TitleFont.Style = []
              OnDblClick = dbgVendasCliente_DadosDblClick
              OnTitleClick = dbgVendasCliente_TotaisTitleClick
              RowWrap = 60
              Large = False
              DoubleRowColor = True
              TitleMinHeight = 100
              ...
              ExibirNumerodaLinha = False
              NaoAtribuirDadosaTabelaaoDigitar = False
              GridAssociado = dbgVendasCliente_Dados
              ShowWhenFieldInvisible = False
              CanClickWhenEditing = False
              GravarConfiguracoes = False
              Columns = <
            ...
            object dbgVendasCliente_Meses: TtecDBGrid
              Left = 236
              Top = 0
              Width = 569
              Height = 540
              ...
              TitleFont.Style = []
              OnDblClick = dbgVendasCliente_DadosDblClick
              OnTitleClick = dbgVendasCliente_MesesTitleClick
              RowWrap = 60
              Large = False
              DoubleRowColor = True
              TitleMinHeight = 100
              ...
              ExibirNumerodaLinha = False
              NaoAtribuirDadosaTabelaaoDigitar = False
              GridAssociado = dbgVendasCliente_Totais
              ShowWhenFieldInvisible = False
              CanClickWhenEditing = False
              GravarConfiguracoes = False
            end
            object pnlTotalValores: TPanel
              Left = 0
              Top = 540
              Width = 906
              Height = 44
              Align = alBottom
              Caption = 'pnlTotalValores'
              TabOrder = 3
              ...
              object dbgVendasTotais_Meses: TtecDBGrid
                Left = 236
                Top = 1
                Width = 569
                Height = 42
                Align = alClient
                DataSource = dtmConsultaVendas.dsrVendasTotais
                Font.Charset = DEFAULT_CHARSET
                Font.Color = clBlack
                Font.Height = -10
                Font.Name = 'helvetica'
          ...
          object tstQuantidade: TTabSheet
            Caption = '&2 - Quantidades'
            ImageIndex = 1
            object dbgVendas_Cliente: TtecDBGrid
              Left = 0
              Top = 0
              Width = 419
              Height = 540
              Align = alLeft
              DataSource = dtmConsultaVendas.dsrVendas
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clBlack
              Font.Height = -10
              Font.Name = 'helvetica'
              ...
              TitleFont.Pitch = fpVariable
              TitleFont.Style = []
              OnDblClick = dbgVendas_ClienteDblClick
              RowWrap = 60
              Large = False
              DoubleRowColor = True
              TitleMinHeight = 100
            ...
            object dbgVendas_Quantidades: TtecDBGrid
              Left = 808
              Top = 0
              Width = 98
              Height = 540
            ...
            object dbgVendas_Meses: TtecDBGrid
              Left = 419
              Top = 0
              Width = 389
              Height = 540
            ...
            object pnlQuantidade: TPanel
              ...
              object dbgVendasQuantidades: TtecDBGrid
                Left = 419
                Top = 1
                Width = 386
                Height = 42
                Align = alClient
                DataSource = dtmConsultaVendas.dsrVendasQuantidades
                Font.Charset = DEFAULT_CHARSET
                Font.Color = clBlack
                Font.Height = -10
                Font.Name = 'helvetica'
  ...
  object gbxTituloVendedor: TGroupBox
    Left = 1024
    Top = 36
    Width = 209
    Height = 41
  ...
  object gbxTituloCliente: TGroupBox
    Left = 152
    Top = 36
    Width = 377
    Height = 41
  ...
  object gbxFoneCliente1: TGroupBox
    Left = 523
    Top = 36
    Width = 170
    Height = 41
    ...
    object edtDDD: TDBEditNumero
      ...
      Tamanho = 3
      DataField = 'foneddd'
      DataSource = dtmConsultaVendas.dsrProcuraCliente
    end
    object DBEditFone1: TDBEditFone
      Tag = 8
      Left = 84
      Top = 16
      Width = 82
  ...
  object gbxFoneClienteComl: TGroupBox
    Left = 859
    Top = 36
    Width = 169
    Height = 41
    ...
    object DBEditFone2: TDBEditFone
      Tag = 8
      Left = 84
      Top = 16
      Width = 79
  ...
  object gbxFoneCliente2: TGroupBox
    Left = 691
    Top = 36
    Width = 170
    Height = 41
    ...
    object DBEditFone3: TDBEditFone
      Tag = 8
      Left = 84
      Top = 16
      Width = 82
