inherited frmEmissaoNotaComplementar: TfrmEmissaoNotaComplementar
  Left = 411
  Top = 151
  ActiveControl = fraConsultaFilial
  Caption = 'Emiss'#227'o de notas fiscais complementares'
  ClientHeight = 541
  ClientWidth = 804
  Color = clBtnFace
  ...
  object pnlFiltro: TPanel
    ...
    object gbxEmissao: TGroupBox
      ...
      object dtxEmissao: TtecDBText
        ...
        Color = clBtnFace
        DataField = 'data'
        DataSource = dtmEmissaoNotaComplementar.dsrConsultaDadosFiscais
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -12
        Font.Name = 'Arial'
    ...
    object gbxNrNota: TGroupBox
      ...
      inline fraConsultaNota: TfraConsultaCodigo
        ...
        inherited dtxDescricao: TtecDBText
          Width = 2
          DataField = 'numero'
          DataSource = fraConsultaFilial.dsrprocuraNotas
        end
    ...
    object gbxFilial: TGroupBox
      ...
      inline fraConsultaFilial: TfraConsultaCodigo
        ...
        inherited edfCodigo: TtecDBFindLookup
          ...
          SetControls = <
            item
              Control = pgcprodutosnotacomplemtar
            end>
    ...
    object gbxSerie: TGroupBox
      ...
      inline fraConsultaSerie: TfraConsultaCodigo
        ...
        inherited edfCodigo: TtecDBFindLookup
          ...
          TabOrder = 0
          LookupField = 'serie'
          LookupSource = fraConsultaSerie.dsrProcuraSerie
          Parameter = 'serie'
          LookupParameter = 'serie'
        end
        inherited qryProcuraSerie: TtecQuery
          inherited qryProcuraSeriefilial: TIntegerField
            DisplayFormat = '0'
          end
        end
      end
    end
    object gbxnovoNumeronota: TGroupBox
      Left = 588
      Top = 5
      Width = 101
      Height = 38
      Caption = 'NOVO N'#186' NOTA'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -9
      Font.Name = 'helvetica'
      ...
      TabOrder = 5
      Visible = False
      object dtxnovonumero: TtecDBText
        Left = 2
        Top = 10
        Width = 95
        Height = 24
        ...
        Color = clBtnFace
        DataField = 'numeronota'
        DataSource = dtmEmissaoNotaComplementar.dsrDadosFiscais
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -13
        Font.Name = 'Arial'
  ...
  object pgcprodutosnotacomplemtar: TtecPageControl
    Left = 0
    Top = 237
    Width = 804
    Height = 304
    ActivePage = tstCliente
    Align = alClient
    TabIndex = 0
    TabOrder = 2
    TabWidth = 130
    OnChange = pgcprodutosnotacomplemtarChange
    object tstCliente: TTabSheet
      Caption = '&1 - Cliente'
      ImageIndex = 5
      object gbxCliente: TGroupBox
        ...
        inline fraEndereco: TfraEndereco
          Left = 2
          Top = 18
          Width = 792
          Height = 152
    ...
    object tstProdutos: TTabSheet
      ...
      object dbgProdutos: TtecDBGrid
        ...
        Height = 249
        Align = alClient
        DataSource = dtmEmissaoNotaComplementar.dsrConsultaProdutos
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -13
        Font.Name = 'helvetica'
    ...
    object tstObservacoes: TTabSheet
      ...
      object pnlObservacoes: TPanel
        ...
        BevelOuter = bvNone
        TabOrder = 0
        object gbxObservacoesComplementares: TGroupBox
          Left = 0
          Top = 0
          Width = 795
          Height = 270
          Align = alClient
          Caption = 'DESCRI'#199#195'O COMPLEMENTAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -9
          Font.Name = 'helvetica'
          ...
          object mmoObservacoesComplementares: TtecDBMemo
            Left = 2
            Top = 20
            Width = 791
            Height = 248
    ...
    object tstTotaisNota: TTabSheet
      Caption = '&5 - Totais da Nota'
      ImageIndex = 2
      ...
      object gbxICMSSubstituicacao: TGroupBox
        ...
        Width = 110
        Height = 36
        Caption = 'ICMS SUBSTITUI'#199#194'O'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -9
        Font.Name = 'helvetica'
        ...
        ParentFont = False
        TabOrder = 7
        object sbnGerarICMSSubst: TSpeedButton
          Left = 84
          Top = 12
          Width = 23
          Height = 23
          Hint = 'Recalcula o valor total do ICMS/Base Subst. (Ctrl I)'
          Flat = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
          ...
          NumGlyphs = 2
          ParentFont = False
          OnClick = sbnGerarICMSSubstClick
        end
        object edtICMSSubstituicao: TDBEditNumero
          ...
          OnChange = edtICMSSubstituicaoChange
          Mascara = True
          Alignment = taLeftJustify
          TipoMascara = tmGERAL
          NrDecimal = 2
    ...
    object tstImpostos: TTabSheet
      Caption = '&7 - Impostos'
      ImageIndex = 3
      object pnlOpcoesImpostos: TPanel
        Left = 766
        Top = 0
        Width = 30
        Height = 273
        ...
        object sbnIncluirAliquotasImpostos: TSpeedButton
          Left = 5
          Top = 69
          Width = 23
          Height = 22
          Hint = 'Incluir impostos ajustados conforme nota fiscal (Ctrl G)'
          Flat = True
          Glyph.Data = {
            36060000424D3606000000000000360000002800000020000000100000000100
            18000000000000060000120B0000120B00000000000000000000DCDCDCDCDCDC
          ...
          NumGlyphs = 2
          Visible = False
          OnClick = sbnIncluirAliquotasImpostosClick
        end
      end
      object dbgImpostos: TtecDBGrid
        Left = 0
        Top = 0
        Width = 766
        Height = 273
        ...
        TitleFont.Pitch = fpVariable
        TitleFont.Style = []
        OnDblClick = dbgImpostosDblClick
        OnKeyDown = dbgImpostosKeyDown
        RowWrap = 60
        Large = False
        DoubleRowColor = False
        MsgDelete = 'IMPOSTO'
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'outras'
            Title.Alignment = taCenter
            Title.Caption = 'OUTRAS OPERA'#199#213'ES'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clBlack
            Title.Font.Height = -9
            Title.Font.Name = 'helvetica'
