...
uses
  ...
  Grids, ActnList, ImgList, ValEdit, StdCtrls, CheckLst,
  ShellAPI, frintervalodatas,
...
//    MapItem:=DimensionMap.Find(Items[ItemIndex]);
    MapItem:=DimensionMap.Find('_'+inttostr(ItemIndex)+'_');
...
begin
  ...
  begin
    dtmAlteracoesPrecos.AbrirConsulta(
      ...
      fraMultiplaSelecaoAleatoriAProdutos.fraSelecaoaleatoriaclassesprodutos.ListaCondicional,
      fraMultiplaSelecaoAleatoriAProdutos.fraSelecaoAleatoriamarcasProdutos.ListaCondicional);
    if dtmAlteracoesPrecos.qryAlteracoesPrecos.RecordCount <> 0 then
