  ...
  object qryRelatorioContratosSituacao: TtecQuery
    ...
    Sql.Strings = (
      ...
      '       vf.nome as nomecliente,'
        ...
        '       valorcurtoprazo(:exercicio, vi.contrato, cast(:DataSituac' +
        'aoEm as date)) as recebimentoscurtoprazo,'
      
        '       valorlongoprazo(:exercicio, vi.contrato, cast(:DataSituac' +
        'aoEm as date)) as recebimentoslongoprazo,'
