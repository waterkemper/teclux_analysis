inherited dtmrelatorioContratosSituacao: TdtmrelatorioContratosSituacao
  ...
  object qryRelatorioContratosSituacao: TtecQuery
    ...
    Sql.Strings = (
      ...
      '       vf.nome as nomecliente,'
        ...
        '       saldodevedorimoveis(vi.contrato, :DataSituacaoEm) as sald' +
        'odevedor,'
      
        '       valorcurtoprazo(:exercicio, vi.contrato, :DataSituacaoEm)' +
        ' as recebimentoscurtoprazo,'
      
        '       valorlongoprazo(:exercicio, vi.contrato, :DataSituacaoEm)' +
        ' as recebimentoslongoprazo,'
      '       (select sum(pi.avpvalor)'
      '        from parcelasimoveis pi'
      '        where pi.contrato = vi.contrato and'
      '              pi.avpprazo = '#39'CURTO'#39' and'
      
        '              (pi.datapagto is null or pi.datapagto >= :DataSitu' +
        'acaoEm)) as AVPCurtoPrazo,'
      ''
      '       (select sum(pi.avpvalor)'
      '        from parcelasimoveis pi'
      '        where pi.contrato = vi.contrato and'
      ...
      '      (select b.descricao'
        ...
        '       from imoveisvendidos iv join blocos b on iv.bloco = b.cod' +
        'igo'
      
        '       where iv.contrato = vi.contrato order by iv.precovenda de' +
        'sc limit 1) as descricaobloco,'
      ''
      '      (select tu.nome'
      
        '       from imoveisvendidos iv join tiposunidades tu on iv.unida' +
        'de = tu.codigo'
      
        '       where iv.contrato = vi.contrato order by iv.precovenda de' +
        'sc limit 1) as nomeunidade,'
      ''
      '      (select iv.numero'
      '       from imoveisvendidos iv'
      
        '       where iv.contrato = vi.contrato order by iv.precovenda de' +
        'sc limit 1) as numero,'
      ''
      '      (select i.areaprivativa + i.areacomum'
      
        '       from imoveisvendidos iv join imoveis i on iv.bloco = i.bl' +
        'oco and iv.numero = i.numero and iv.unidade = i.unidade'
      
        '       where iv.contrato = vi.contrato order by iv.precovenda de' +
        'sc limit 1) as areatotal'
      ''
    ...
    object qryRelatorioContratosSituacaosaldodevedor: TFloatField
  ...
  object frxRelatorioContratosSituacao: TfrxReport
    ...
    ReportOptions.LastChange = 42963.507703402800000000
      ...
      object GroupFooterSituacao: TfrxGroupFooter
        ...
        object Memo46: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              'Totais da Situa'#195#167#195#163'o [frxDBRelatorioContratosSituacao."nomesitua' +
              'cao"]')
          ParentFont = False
        end
        ...
        object Memo21: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBParcelas."valordevidoinicioperiodo">,MasterData1)]')
          ParentFont = False
        end
      ...
      object GroupFooterEmpreendimento: TfrxGroupFooter
        ...
        object Memo27: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              'Totais do Empreendimento [frxDBRelatorioContratosSituacao."nomee' +
              'mpreendimento"]')
          ParentFont = False
        end
