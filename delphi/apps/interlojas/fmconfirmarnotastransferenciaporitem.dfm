inherited frmConfirmarNotasTransferenciaPorItem: TfrmConfirmarNotasTransferenciaPorItem
  Left = 625
  Top = 240
  Action = actHabilitarBotoes
  ActiveControl = dbgPedidosFiliais
  ...
  inherited pnlTopMenu: TPanel
    ...
    inherited tblBarra: TToolBar
      ...
      object sbnGerar: TSpeedButton
        ...
        Width = 75
        Height = 43
        Hint = 'Gerar consulta das Notas Transfer'#234'ncias'
        Caption = 'Gerar F6'
        Flat = True
        Glyph.Data = {
  ...
  object pnlFundoJanela: TPanel
    ...
    BorderWidth = 3
    TabOrder = 2
    object gbxConfirmarNotasTransferecia: TGroupBox
      Left = 3
      Top = 3
      Width = 766
      Height = 421
      ...
      object dbgPedidosFiliais: TtecDBGrid
        Left = 10
        Top = 103
        Width = 755
        Height = 321
        DataSource = dtmConfirmarNotasTransferenciaPorItem.dsrPedidosFiliais
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        font.height = -12
        Font.Name = 'helvetica'
        ...
        TitleFont.Style = []
        OnDrawColumnCell = dbgPedidosFiliaisDrawColumnCell
        OnDblClick = dbgPedidosFiliaisDblClick
        RowWrap = 60
        Large = False
        DoubleRowColor = True
        TitleMinHeight = 100
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'NOTA e S'#201'RIE'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clBlack
            Title.font.height = -9
            Title.Font.Name = 'helvetica'
      ...
      object gbxUsuario: TGroupBox
        ...
        ParentFont = False
        TabOrder = 1
        object sbnProcuraUsuarios: TSpeedButton
          Left = 56
          Top = 11
          Width = 23
          Height = 22
          Hint = 'Procurar usu'#225'rios'
          Flat = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          font.height = -12
          ...
          NumGlyphs = 2
          ParentFont = False
          OnClick = sbnProcuraUsuariosClick
        end
        object edfUsuario: TtecDbEditFind
          Left = 2
          Top = 10
          Width = 53
          Height = 20
          DataField = 'codigo'
          DataSource = dtmConfirmarNotasTransferenciaPorItem.dsrProcurarUsuarios
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          font.height = -12
          Font.Name = 'helvetica'
        ...
        object dtxDescricaoUsuarios: TtecDBText
          Left = 79
          Top = 10
          Width = 278
          Height = 20
