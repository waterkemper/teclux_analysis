inherited frmTransferenciaRequisicaoExposicao: TfrmTransferenciaRequisicaoExposicao
  ...
  ActiveControl = dbgTransferenciaRequisicao
  ...
  object pnlFundoJanela: TPanel
    ...
    object pnlParametros: TPanel
      ...
      object gbxLoteTransferencia: TGroupBox
        ...
        ParentFont = False
        TabOrder = 7
        object dblLotesPedidosFiliais: TTecDBLookupComboBox
          Left = 4
          Top = 12
          Width = 71
          Height = 23
          ...
          DataSource = dtmTransferenciaRequisicaoExposicao.dsrLotesPedidosFiliais_
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
          Font.Pitch = fpVariable
          Font.Style = []
          KeyField = 'lotetransferencia'
          ListField = 'lotetransferencia'
          ListSource = dtmTransferenciaRequisicaoExposicao.dsrLotesPedidosFiliais
          ParentFont = False
          TabOrder = 0
          OnCloseUp = dblLotesPedidosFiliaisCloseUp
        end
      end
    end
