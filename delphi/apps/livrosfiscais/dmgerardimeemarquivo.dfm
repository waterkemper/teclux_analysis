inherited dtmGerarDIMEEmArquivo: TdtmGerarDIMEEmArquivo
  Left = 609
  Top = 225
  Height = 431
  Width = 701
  ...
  object qryQuadrosDIME: TtecQuery
    ...
    Sql.Strings = (
      'select filial,'
        ...
        '       (select inscricaoestadual from filiais where codigo = fil' +
        'ial) as inscricaoestadual,'
      
        '       (select razao from filiais where codigo = filial) as raza' +
        'o, '
      '       periodo,'
      ...
      '      q11_160_Totalajustesapdecendial,'
      ''
      ...
      '   %ListadeFiliais'
      ''
      '   and periodo between (:MesInicial) and (:MesFinal)'
    ...
    object qryQuadrosDIMEinscricaoestadual: TStringField
      FieldName = 'inscricaoestadual'
      Size = 50
    end
    object qryQuadrosDIMErazao: TStringField
      FieldName = 'razao'
      Size = 50
    end
  ...
  object qryq12_discrpagtos: TtecQuery
    ...
    Sql.Strings = (
      ...
      '          datavencto    ,'
      '         valor              ,'
      '         cast(numeroacordo as integer) as numeroacordo'
    ...
    object qryq12_discrpagtosnumeroacordo: TIntegerField
  ...
  object qryq50_saimercforneletrservicostotal: TtecQuery
    Tag = -1
    Database = dtmTecSoft.dbaTecSoft
    Transaction = dtmTecSoft.tstTecSoft
    CachedUpdates = False
    ...
    Sql.Strings = (
      'select '
      ' cast('#39'TT'#39' as varchar) as estado,'
      ' sum(valorcontabil_naocontrib) as valorcontabil_naocontrib,'
      ' sum(valorcontabil_contrib) as valorcontabil_contrib,'
      ' sum(basedecalculo_naocontrib) as basedecalculo_naocontrib,'
      ' sum(basedecalculo_contrib) as basedecalculo_contrib,'
      ' sum(outras) as outras,'
      ' sum(icmsretidosubstrib) as icmsretidosubstrib'
      'from q50_saimercforneletrservicos'
      'where filial = :filial and'
      '           periodo = :periodo')
    RequestLive = False
    ...
    object qryq50_saimercforneletrservicostotalestado: TStringField
      FieldName = 'estado'
      Size = 2
    end
    object qryq50_saimercforneletrservicostotalvalorcontabil_naocontrib: TFloatField
      FieldName = 'valorcontabil_naocontrib'
    end
    object qryq50_saimercforneletrservicostotalvalorcontabil_contrib: TFloatField
      FieldName = 'valorcontabil_contrib'
    end
    object qryq50_saimercforneletrservicostotalbasedecalculo_naocontrib: TFloatField
      FieldName = 'basedecalculo_naocontrib'
    end
    object qryq50_saimercforneletrservicostotalbasedecalculo_contrib: TFloatField
      FieldName = 'basedecalculo_contrib'
    end
    object qryq50_saimercforneletrservicostotaloutras: TFloatField
      FieldName = 'outras'
    end
    object qryq50_saimercforneletrservicostotalicmsretidosubstrib: TFloatField
      FieldName = 'icmsretidosubstrib'
    end
  end
  object qryq49_entmercbensaqservicostotal: TtecQuery
    Tag = -1
    Database = dtmTecSoft.dbaTecSoft
    Transaction = dtmTecSoft.tstTecSoft
    CachedUpdates = False
    ...
    Macros = <>
    Sql.Strings = (
      'select cast('#39'TT'#39' as varchar) as estado,'
      '          sum(valorcontabil) as  valorcontabil,'
      '          sum(basedecalculo) as basedecalculo,'
      '          sum(outras) as outras,'
      '          sum(icmsretidosubstrib1) as icmsretidosubstrib1,'
      '          sum(icmsretidosubstrib2) as icmsretidosubstrib2'
      'from q49_entmercbensaqservicos'
      'where filial = :filial and'
      '           periodo = :periodo')
    RequestLive = False
    ...
    object qryq49_entmercbensaqservicostotalestado: TStringField
      FieldName = 'estado'
      Size = 2
    end
    object qryq49_entmercbensaqservicostotalvalorcontabil: TFloatField
      FieldName = 'valorcontabil'
    end
    object qryq49_entmercbensaqservicostotalbasedecalculo: TFloatField
      FieldName = 'basedecalculo'
    end
    object qryq49_entmercbensaqservicostotaloutras: TFloatField
      FieldName = 'outras'
    end
    object qryq49_entmercbensaqservicostotalicmsretidosubstrib1: TFloatField
      FieldName = 'icmsretidosubstrib1'
    end
    object qryq49_entmercbensaqservicostotalicmsretidosubstrib2: TFloatField
      FieldName = 'icmsretidosubstrib2'
    end
  end
  object qryq48_recprestservfornenereletricatotal: TtecQuery
    Tag = -1
    Database = dtmTecSoft.dbaTecSoft
    Transaction = dtmTecSoft.tstTecSoft
    CachedUpdates = False
    ...
    Macros = <>
    Sql.Strings = (
      'select cast('#39'99999'#39' as integer) as codmunicipio,'
      '          sum(valor) as valor'
      'from q48_recprestservfornenereletrica'
      'where filial = :filial and'
      '           periodo = :periodo')
    ...
    object qryq48_recprestservfornenereletricatotalcodmunicipio: TIntegerField
      FieldName = 'codmunicipio'
    end
    object qryq48_recprestservfornenereletricatotalvalor: TFloatField
      FieldName = 'valor'
    end
  end
  object qryq47_compraexproagroptotal: TtecQuery
    Tag = -1
    Database = dtmTecSoft.dbaTecSoft
    Transaction = dtmTecSoft.tstTecSoft
    CachedUpdates = False
    ...
    object qryq47_compraexproagroptotalcodmunicipio: TIntegerField
      FieldName = 'codmunicipio'
    end
    object qryq47_compraexproagroptotalvalor: TFloatField
      FieldName = 'valor'
    end
  end
  object qryq46_RegimeEspecialtotal: TtecQuery
    Tag = -1
    Database = dtmTecSoft.dbaTecSoft
    Transaction = dtmTecSoft.tstTecSoft
    CachedUpdates = False
    ...
    Macros = <>
    Sql.Strings = (
      'select cast(0 as integer) as regime,'
      '          sum(valor) as valor,'
    ...
    object qryq46_RegimeEspecialtotalregime: TIntegerField
      FieldName = 'regime'
      DisplayFormat = '0'
    end
    object qryq46_RegimeEspecialtotalvalor: TFloatField
      FieldName = 'valor'
      DisplayFormat = '0.00'
    end
    object qryq46_RegimeEspecialtotalorigem: TIntegerField
      FieldName = 'origem'
      DisplayFormat = '0'
    end
  end
