    ...
    object pnlTop: TPanel
      ...
      object rbnSituacao: TtecDBRadioGroup
        ...
        object tecRadioButton5: TtecRadioButton
          ...
          Width = 119
          Height = 17
          Caption = '5 - Transforma'#231#227'o'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
      ...
      object rbnind_sit_ini_per: TtecDBRadioGroup
        ...
        Width = 485
        Height = 91
        Caption = ' SITUA'#199#195'O NO IN'#205'CIO DO PER'#205'ODO '
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -9
        Font.Name = 'helvetica'
        ...
        object tecRadioButton4: TtecRadioButton
          ...
          Height = 17
          Caption = 
            '3 - In'#237'cio de obrigatoriedade da entrega da ECD no curso do ano ' +
            'calend'#225'rio'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
      ...
      object rgrEscrituracao: TtecDBRadioGroup
        Left = 643
        Top = 7
        Width = 105
        Height = 53
        Hint = 'Finalidade da escritura'#231#227'o'
        ...
        object rbnSubstituta: TtecRadioButton
          Left = 6
          Top = 30
          Width = 95
          Height = 16
          Hint = 'Finalidade da escritura'#231#227'o'
          Caption = '1 - Substituta'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
      ...
      object stxEmpresaDe: TStaticText
        Left = 659
        Top = 69
        Width = 64
        Height = 16
        Hint = 'Entidade sujeita a auditoria independente'
        Caption = 'EMPRESA DE'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -9
      ...
      object GroupBox1: TGroupBox
        ...
        Height = 36
        Hint = 
          'A escritura'#231#227'o abrange valores com base na moeda funcional (art.' +
          ' 156 da Instru'#231#227'o Normativa RFB no 1.515, de 24 de novembro de 2' +
          '014).'
        Caption = 'FUNCIONAL'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object tecDBRadioGroup2: TtecDBRadioGroup
        ...
        TabOrder = 6
        TabStop = False
        DataField = 'ind_emp_grd_prt'
        DataSource = dtmECD.dsrecd
        object tecRadioButton9: TtecRadioButton
          Left = 16
          Top = 14
          Width = 65
          Height = 17
        ...
        object tecRadioButton10: TtecRadioButton
          Left = 16
          Top = 30
          Width = 65
          Height = 18
      ...
      object stxIdentificacao: TStaticText
        Left = 501
        Top = 136
        Width = 76
        Height = 16
      ...
      object gbxOutrasInformacoes: TGroupBox
        Left = 588
        Top = 165
        Width = 90
        Height = 36
        Hint = 
          'O registro J800 permite que seja anexado um arquivo em formato t' +
          'exto RTF (Rich Text Format) na escritura'#231#227'o, que se destina a re' +
          'ceber informa'#231#245'es que devam constar do livro, tais como notas ex' +
          'plicativas, outras demonstra'#231#245'es cont'#225'beis, pareceres, relat'#243'rio' +
          's, etc.'
      ...
      object rgbINd_esc: TtecDBRadioGroup
        Left = 6
        Top = 238
        Width = 539
        Height = 107
        Caption = 'INDICADOR DA FORMA DE ESCRITURA'#199#195'O CONT'#193'BIL'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -9
        Font.Name = 'helvetica'
        ...
        DataField = 'ind_esc'
        DataSource = dtmECD.dsrecd
        object rbnIndEsc_G: TtecRadioButton
          Left = 6
          Top = 17
          Width = 459
          Height = 17
          Caption = 
            'G - Livro Di'#225'rio (Completo sem escritura'#231#227'o auxiliar) ou Livro A' +
            'uxiliar da SCP'
          Checked = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object rbnIndEsc_R: TtecRadioButton
          Left = 6
          Top = 34
          Width = 427
          Height = 17
          Caption = 
            'R - Livro Di'#225'rio com Escritura'#231#227'o Resumida (com escritura'#231#227'o aux' +
            'iliar);'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
        ...
        object rbnIndEsc_A: TtecRadioButton
          Left = 6
          Top = 51
          Width = 371
          Height = 17
          Caption = 'A - Livro Di'#225'rio Auxiliar ao Di'#225'rio com Escritura'#231#227'o Resumida'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
        ...
        object rbnIndEsc_B: TtecRadioButton
          Left = 6
          Top = 68
          Width = 259
          Height = 17
          Caption = 'B - Livro Balancetes Di'#225'rios e Balan'#231'os'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
        ...
        object rbnIndEsc_Z: TtecRadioButton
          Left = 6
          Top = 86
          Width = 531
          Height = 17
          Caption = 
            'Z '#8211' Raz'#227'o Auxiliar (Livro Cont'#225'bil Auxiliar conforme leiaute def' +
            'inido nos registros I500 a I555)'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
      ...
      object gbxSubstituicaoECD: TGroupBox
        Left = 690
        Top = 165
        Width = 85
        Height = 36
        Hint = 
          'A entidade dever'#225' preencher o registro J801 '#8211' Termo de Verifica'#231 +
          #227'o Para Fins de Substitui'#231#227'o da ECD '#8211' detalhando os erros que de' +
          'ram motivo '#224' substitui'#231#227'o.'
        Caption = ' DA ECD '
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -9
      ...
      object stxSubstituicao: TStaticText
        Left = 688
        Top = 151
        Width = 71
        Height = 16
