inherited frmLivroEntradaMercadorias: TfrmLivroEntradaMercadorias
  Left = 812
  Top = 55
  ActiveControl = edfFilial
  Caption = 'Livro de Entrada de Mercadorias'
  ClientHeight = 568
  ClientWidth = 381
  ...
  inherited pnlFundoJanela: TPanel
    ...
    Width = 381
    Height = 528
    object gbxLivroEntradaMercadorias: TGroupBox
      Left = 3
      Top = 3
      Width = 375
      Height = 522
      ...
      object gbxImprimir: TGroupBox
        ...
        ParentFont = False
        TabOrder = 6
        object ckbLivroEntradas: TCheckBox
          Left = 6
          Top = 12
          Width = 154
          Height = 23
        ...
        object ckbCodigosEmitentes: TCheckBox
          ...
          Width = 154
          Height = 23
          Caption = '&C'#243'digos dos emitentes'
          Checked = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
        ...
        object ckbResumoSintetico: TCheckBox
          Left = 6
          Top = 50
          Width = 154
          Height = 23
      ...
      object gbxGrupos: TGroupBox
        ...
        object sbnMarcarNaturezas: TSpeedButton
          ...
          Width = 22
          Height = 22
          Hint = 'Assinalar todas as naturezas'
          Flat = True
          Glyph.Data = {
        ...
        object sbnDesmarcarNaturezas: TSpeedButton
          ...
          Width = 22
          Height = 22
          Hint = 'Desmarcar todas as naturezas'
          Flat = True
          Glyph.Data = {
            36060000424D3606000000000000360000002800000020000000100000000100
            18000000000000060000120B0000120B00000000000000000000DCDCDCDCDCDC
      ...
      object gbxFilial: TGroupBox
        ...
        object edfFilial: TtecDbEditFind
          ...
          DataField = 'codigo'
          DataSource = dtmLivroEntradaMercadorias.dsrProcuraFiliais
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
          Font.Name = 'helvetica'
      ...
      object gbxArquivoDCIP: TGroupBox
        Left = 10
        Top = 472
        Width = 355
        Height = 36
        Caption = ' ARQUIVO DCIP A EXPORTAR '
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -9
        Font.Name = 'helvetica'
  ...
  object stxFechamento: TStaticText
    Left = 99
    Top = 212
    Width = 68
    Height = 10
