  ...
  object qrySaldoContabil: TtecQuery
    ...
    Sql.Strings = (
      ';'
        ...
        'select sum(SaldoContabil(sel.codigo, :filial, case when sel.alfa' +
        '='#39'I'#39' then cast(:datainicialmes as date)-1 else :datafinal end, :' +
        'exercicio)) as Saldo'
      'from'
      '('
  ...
  object qryecf_l300: TtecQuery
    ...
    Sql.Strings = (
      ...
      ''
        ...
        '      GROUP BY pr.Classificacao, pr.Tipo, pr.Descricao, Meses.Se' +
        'q, Meses.Mes'
  ...
  object qryAtualizar_ecf_l210: TtecQuery
    ...
    Sql.Strings = (
      '/* INCLUIR REGISTROS NA TABELA ECF_L210 */'
        ...
        '030,listacontascontabeis,valor)'
      ''
      '('
      ...
      ''
        ...
        'l.alfa='#39'I'#39' then pa.datainicialmes-1 else pa.datafinal end, :exer' +
        'cicio))'
      '      from'
      '       ('
  ...
  object qryAtualizar_ecf_M300: TtecQuery
    ...
    Sql.Strings = (
      '/* INCLUIR REGISTROS NA TABELA ECF_m300 */'
        ...
        '030,listacontascontabeis,valor, ind_relacao)'
      '('
      ...
      ''
        ...
        'sel.alfa='#39'I'#39' then pa.datainicialmes-1 else pa.datafinal end, :ex' +
        'ercicio))'
      '        from'
      '         ('
