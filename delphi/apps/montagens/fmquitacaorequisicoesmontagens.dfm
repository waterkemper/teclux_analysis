inherited frmQuitacaoRequisicoesMontagens: TfrmQuitacaoRequisicoesMontagens
  Left = 402
  Top = 97
  ActiveControl = pgcGeracaoRequisicoes
  Caption = 'Quita'#231#227'o das Requisi'#231#245'es de Montagens'
  ClientHeight = 560
  ClientWidth = 850
  ...
  inherited pnlTopMenu: TPanel
    ...
    inherited tblBarraCadastro: TToolBar
      ...
      object sbnConfirma: TSpeedButton
        ...
        Width = 75
        Height = 35
        Hint = 'Confirma a quita'#231#227'o das requisi'#231#227'o(s)'
        Caption = 'Confirma F5'
        Enabled = False
        Flat = True
        Glyph.Data = {
  ...
  object pgcGeracaoRequisicoes: TtecPageControl
    ...
    object tstParametros: TTabSheet
      ...
      object gbxParametros: TGroupBox
        ...
        Align = alClient
        TabOrder = 0
        object gbxPeriododeAberturadaRequisicao: TGroupBox
          Left = 9
          Top = 155
          Width = 256
          Height = 65
          Caption = 'Per'#237'odo de Montagem das Requisi'#231#245'es'
          TabOrder = 2
          object lblVencimentoInicial: TLabel
            Left = 8
            Top = 30
            Width = 33
            Height = 16
          ...
          object lblVencimentoFinal: TLabel
            Left = 137
            Top = 30
            Width = 28
            Height = 16
          ...
          object edtMontagemInicial: TEditData
            Left = 45
            Top = 26
            Width = 75
            Height = 24
          ...
          object edtMontagemFinal: TEditData
            Left = 169
            Top = 26
            Width = 75
            Height = 24
        ...
        object gbxMontador: TGroupBox
          ...
          object dtxMontador: TtecDBText
            ...
            Color = clBtnFace
            DataField = 'nome'
            DataSource = dtmQuitacaoRequisicoesMontagens.dsrMontador
            ReadOnly = True
            TabOrder = 0
          end
        ...
        object pgcFilialGrupoFilialMontagem: TtecPageControl
          Left = 8
          Top = 8
          Width = 417
          Height = 73
          ...
          TabStop = False
          TabWidth = 100
          OnChange = pgcFilialGrupoFilialMontagemChange
          object tstFilialMontagem: TTabSheet
            Caption = 'Filial &Montagem'
            object sbnProcuraFilialdeMontagem: TSpeedButton
              Left = 62
              Top = 8
              Width = 25
              Height = 23
              Hint = 'Procurar Filial de Montagem'
            ...
            object edfFilialMontagem: TtecDbEditFind
              Left = 4
              Top = 8
              Width = 57
              Height = 24
              Alignment = taLeftJustify
              DataField = 'codigo'
              DataSource = dtmQuitacaoRequisicoesMontagens.dsrFilialMontagem
              Group = 'FilialMontagem'
              MaxLength = 4
              Maximo = 0
              Minimo = 37353
              Adicional = 0
            ...
            object dtxFilialdeMontagem: TtecDBText
              Left = 94
              Top = 8
              Width = 290
              Height = 24
          ...
          object tstGrupoFilialMontagem: TTabSheet
            ...
            ImageIndex = 1
            object sbnProcuraGrupoFilialMontagem: TSpeedButton
              Left = 62
              Top = 8
              Width = 23
              Height = 23
              ...
              Glyph.Data = {
                ...
                DCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDC}
              NumGlyphs = 2
              OnClick = sbnProcuraGrupoFilialMontagemClick
            end
            object dtxGrupoFilialMontagem: TtecDBText
              Left = 94
              Top = 8
              Width = 290
              Height = 21
              ...
              Color = clBtnFace
              DataField = 'descricao'
              DataSource = dtmQuitacaoRequisicoesMontagens.dsrGrupoFiliaisMontagem
              ReadOnly = True
              TabOrder = 0
            end
    ...
    object tstSelecionados: TTabSheet
      ...
      object gbxQuitacao: TGroupBox
        ...
        object lblContratosMarcados: TLabel
          Left = 110
          Top = 23
          Width = 57
          Height = 16
        ...
        object lblRequisicoesTotal: TLabel
          Left = 42
          Top = 16
          Width = 60
          Height = 23
        ...
        object lblRequisicoesMarcadas: TLabel
          Left = 170
          Top = 16
          Width = 60
          Height = 23
      ...
      object dbgQuitacaoRequisicoes: TtecDBGrid
        Left = 0
        Top = 0
        Width = 838
        Height = 239
        Align = alTop
        DataSource = dtmQuitacaoRequisicoesMontagens.dsrItensRequisicoes
        ...
        TitleFont.Style = []
        OnDrawColumnCell = dbgQuitacaoRequisicoesDrawColumnCell
        OnDblClick = dbgQuitacaoRequisicoesDblClick
        OnKeyDown = dbgQuitacaoRequisicoesKeyDown
        RowWrap = 60
        Large = False
      ...
      object pgcSelecionado: TtecPageControl
        ...
        object tstRequisicao: TTabSheet
          ...
          object gbxObservacao: TGroupBox
            ...
            TabOrder = 0
            object mmoObsMontagem: TtecDBMemo
              Left = 2
              Top = 30
              Width = 343
              Height = 143
          ...
          object pnlRequisicao: TPanel
            ...
            object lblFilialdeMontagem: TLabel
              Left = 7
              Top = 55
              Width = 110
              Height = 16
            ...
            object flkFilialdeMontagemRequisicao: TtecDBText
              Left = 120
              Top = 51
              Width = 65
              Height = 24
            ...
            object dtxMontadorRequisicao: TtecDBText
              Left = 120
              Top = 77
              Width = 65
              Height = 24
            ...
            object dtxVendedorRequisicao: TtecDBText
              Left = 120
              Top = 104
              Width = 65
              Height = 24
        ...
        object tstEnderecoEntrega: TTabSheet
          ...
          ImageIndex = 1
          inline fraEnderecoEntrega: TfraEndereco
            Left = 0
            Top = 0
            Width = 799
            Height = 175
            ...
            inherited gbxEndereco: TGroupBox
              ...
              inherited pnlBairro: TPanel
                ...
                inherited edtBairro: TtecDoubleDBEdit
                  LookupField = 'bairro'
                  LookupSource = dtmQuitacaoRequisicoesMontagens.dsrItensRequisicoes
                  DataField = 'entbairro'
                  DataSource = dtmQuitacaoRequisicoesMontagens.dsrItensRequisicoes
                  MaxLength = 9
                end
          ...
          inline fraFoneRamalEntrega: TfraFoneRamal
            Left = 488
            Top = 0
            Width = 249
            Height = 65
        ...
        object tstContrato: TTabSheet
          ...
          object dbgProdutosContratos: TtecDBGrid
            ...
            Height = 111
            Align = alBottom
            DataSource = dtmQuitacaoRequisicoesMontagens.dsrProdutosContratos
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlack
            Font.Height = -9
            Font.Name = 'helvetica'
          ...
          object pnlContrato: TPanel
            ...
            object lblEmissaoContrato: TLabel
              Left = 256
              Top = 8
              Width = 51
              Height = 16
        ...
        object tstDadosFiscais: TTabSheet
          ...
          ImageIndex = 4
          object dbgProdutosDadosFiscais: TtecDBGrid
            Left = 0
            Top = 63
            Width = 830
            Height = 112
            TabStop = False
            Align = alBottom
            DataSource = dtmQuitacaoRequisicoesMontagens.dsrProdutosDadosFiscais
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlack
            Font.Height = -9
            Font.Name = 'helvetica'
          ...
          object pnlDadosFiscais: TPanel
            ...
            object lblEmissaoNotaFiscal: TLabel
              Left = 176
              Top = 8
              Width = 51
              Height = 16
            ...
            object dtxNotaFiscal: TtecDBText
              Left = 304
              Top = 24
              Width = 72
              Height = 21
        ...
        object tstdadosdoCliente: TTabSheet
          ...
          inline fraEnderecoResidencial: TfraEndereco
            Left = 0
            Top = 31
            Width = 480
            Height = 146
            ...
            inherited gbxEndereco: TGroupBox
              Width = 480
              Height = 146
              Caption = 'ENDERE'#199'O RESIDENCIAL'
              inherited pnlNumero: TPanel
                Width = 476
                inherited edtNumeroEndereco: TDBEditTexto
                  DataField = 'numero'
                  DataSource = dtmQuitacaoRequisicoesMontagens.dsrClientesRequisicoes
                end
                inherited edtComplemento: TDBEditTexto
              ...
              inherited pnlBairro: TPanel
                ...
                inherited edtBairro: TtecDoubleDBEdit
                  ...
                  LookupSource = dtmQuitacaoRequisicoesMontagens.dsrClientesRequisicoes
                  DataField = 'bairro'
                  DataSource = dtmQuitacaoRequisicoesMontagens.dsrClientesRequisicoes
                end
              end
          ...
          inline fraFoneRamalEmpresa: TfraFoneRamal
            Left = 488
            Top = 95
            Width = 249
            Height = 65
            ...
            inherited gbxFone: TGroupBox
              ...
              inherited edtDDD: TDBEditNumero
                ReadOnly = True
                DataField = 'fonedddempresa'
                DataSource = dtmQuitacaoRequisicoesMontagens.dsrClientesRequisicoes
              end
              inherited edtNumero: TDBEditFone
                DataField = 'fonenumeroempresa'
                DataSource = dtmQuitacaoRequisicoesMontagens.dsrClientesRequisicoes
                ReadOnly = True
              end
              inherited edtFoneRamal: TDBEditTexto
                DataField = 'foneramalempresa'
                DataSource = dtmQuitacaoRequisicoesMontagens.dsrClientesRequisicoes
                ReadOnly = True
              end
            end
          end
          inline fraFoneRamalResidencial: TfraFoneRamal
            Left = 488
            Top = 30
            Width = 249
            Height = 65
          ...
          object dtxClienteDadosdoCliente: TtecDBText
            Left = 56
            Top = 4
            Width = 417
            Height = 21
