...
uses
  ...
  fmconsultabasica, fmconsultaporcampo, cpQuery, Grids, DBGrids, cpdbgrid,
  cpdbmemo, cpnumero, ActnList, clparametrossistema,
  fmprincipalbasico, ToolWin,fmconsultavendas;

type
  TfrmLigarClientes = class(TfrmRelatorioPadrao)
    gbxLigarClientes: TGroupBox;
...
begin
  ...
  begin
    ...
    with dtmLigarClientes do begin
      ...
      if not SelecionarclientesLigar then begin
...
function TfrmLigarClientes.TabelaDePesquisa: TTecQuery;
begin
  with dtmLigarClientes do
    case TipoPesquisa of
