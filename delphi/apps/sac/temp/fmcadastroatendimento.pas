...
uses
  ...
  AdvDBDateTimePicker, AdvEdit, AdvEdBtn, DBPlannerDatePicker;
...
//  edttpLembrar.MaxDate := dtmCadastroAtendimentos.DataServidor + 90;
  edttpLembrar.Calendar.MaxDate.Date := dtmCadastroAtendimentos.DataServidor + 90;
...
function TfrmCadastroAtendimento.TabelaDePesquisa: TTecQuery;
begin
  with dtmCadastroAtendimentos do begin
    case TipoConsulta of
...
begin
  inherited;
  dtmCadastroAtendimentos.AbrirJanelaSelecaoImpressao;
end;
