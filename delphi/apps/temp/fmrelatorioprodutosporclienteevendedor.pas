...
uses
  ...
  cpdbtext, Mask, cpdbfindcontrols, QCheckLst, ComCtrls, cppagecontrol,
  // Repositorio
  ...
  ctconstantes, biblio,
  // Terceiros
  ZQuery, frlistafiliais, frlistagruposfiliais, frordenacao;
...
begin
  ...
  case TipoPesquisa of
    ...
    pesFORNECEDORES      : Result := ExisteFornecedor(NomeCampo, Value);
...
begin
  with dtmRelatorioProdutosporClienteeVendedor do
    case TipoPesquisa of
      pesITEMPRODUTOS : Result := ConsultarItemProduto;
      ...
      pesFORNECEDORES : Result := ConsultarFornecedor;
...
procedure TfrmRelatorioProdutosporClienteeVendedor.sbnConsultaItemProdutoClick(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmRelatorioProdutosporClienteeVendedor.sbnConsultaProdutosClick(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmRelatorioProdutosporClienteeVendedor.sbnConsultaGrupoProdutoClick(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmRelatorioProdutosporClienteeVendedor.sbnConsultaClasseClick(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmRelatorioProdutosporClienteeVendedor.sbnProcuraMarcaClick(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmRelatorioProdutosporClienteeVendedor.sbnProcuraFornecedorClick(
  Sender: TObject);
begin
  inherited;
...
begin
  if ValidarCamposSelecao then begin
    ...
    begin
      ...
      ParametroItem       := edfItemProduto.Text;
      ParametroCodigo     := edfProduto.Text;
      ...
      ParametroFornecedor := edfFornecedor.Text;
      ...
      begin
        ...
        if Result then
           Result := OperadorTernario((Trim(edfItemProduto.Text) <> ''), edfItemProduto.Exist, True) and
                     ...
                     OperadorTernario((Trim(edfMarca.Text) <> ''), edfMarca.Exist, True) and
