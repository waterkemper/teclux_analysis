...
//    procedure qryNotasDevolucoesContratoAfterScroll(DataSet: TDataSet);
    ...
    procedure qryProdutosContratosLotesnrloteSetText(Sender: TField;
      const Text: String);
    procedure cdsProdutosContratosLotesCalcFields(DataSet: TDataSet);
  private
...
begin
  ...
  begin
    ...
    frmVisualizarProdutosContratosSeries := TfrmVisualizarProdutosContratosSeries.create(self, self);
...
begin
  ...
  cdsProdutosContratosLotes.close;
  cdsProdutosContratosLotes.open;
...
procedure TdtmCadastroContratos.cdsProdutosContratosLotesCalcFields(
  DataSet: TDataSet);
begin
  inherited;
  if qryProdutosContratosLotes.recordcount>0 then
  begin
    cdsProdutosContratosLotesTotalQuantidade_.asvariant := cdsProdutosContratosLotesTotalQuantidade.asvariant;
    cdsProdutosContratosLotesTotalDevolvidos_.asvariant := cdsProdutosContratosLotesTotalDevolvidos.asvariant;
    cdsProdutosContratosLotesTotalTrocados_.asvariant := cdsProdutosContratosLotesTotalTrocados.asvariant;
  end;  
end;
