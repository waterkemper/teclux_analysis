...
type
  TdtmRelatorioProdutosporClienteeVendedor = class(TdtmBasico)
    ...
    qryRelatorioProdutosClientes_: TtecQuery;
    qryRelatorioProdutosClientes_cliente: TIntegerField;
    qryRelatorioProdutosClientes_tipocliente: TStringField;
    qryRelatorioProdutosClientes_nomecliente: TStringField;
    qryRelatorioProdutosClientes_contrato: TStringField;
    qryRelatorioProdutosClientes_pedidocliente: TStringField;
    qryRelatorioProdutosClientes_situacao: TStringField;
    qryRelatorioProdutosClientes_faturamento: TDateField;
    qryRelatorioProdutosClientes_filialvenda: TIntegerField;
    qryRelatorioProdutosClientes_dadofiscal: TIntegerField;
    qryRelatorioProdutosClientes_data: TDateField;
    qryRelatorioProdutosClientes_quantidade: TFloatField;
    qryRelatorioProdutosClientes_produto: TLargeintField;
    qryRelatorioProdutosClientes_produtovisual: TStringField;
    qryRelatorioProdutosClientes_filial: TIntegerField;
    qryRelatorioProdutosClientes_descricao: TStringField;
    qryRelatorioProdutosClientes_precovenda: TFloatField;
    qryRelatorioProdutosClientes_precotabela: TFloatField;
    qryRelatorioProdutosClientes_totalprecovenda: TFloatField;
    qryRelatorioProdutosClientes_totalprecotabela: TFloatField;
    qryRelatorioProdutosClientes_devolucao: TDateField;
    qryRelatorioProdutosClientes_desconto: TFloatField;
    qryRelatorioProdutosClientes_registro: TStringField;
    qryRelatorioProdutosClientes_ncm: TStringField;
    qryRelatorioProdutosClientes_maquina: TIntegerField;
    qryRelatorioProdutosClientes_intervensao: TIntegerField;
    qryRelatorioProdutosClientes_numerocupom: TIntegerField;
    qryRelatorioProdutosClientes_serie: TStringField;
    qryRelatorioProdutosClientes_numeronota: TIntegerField;
    qryRelatorioProdutosClientes_produto_cliente: TStringField;
    qryRelatorioProdutosClientes_rua: TStringField;
    qryRelatorioProdutosClientes_bairro: TStringField;
    qryRelatorioProdutosClientes_cep: TIntegerField;
    qryRelatorioProdutosClientes_cidade: TStringField;
    qryRelatorioProdutosClientes_pessoanumero: TStringField;
    fdsRelatorioProdutosClientes_: TfrDBDataSet;
    tecQuery1: TtecQuery;
    qryRelatorioProdutosVendedoresticket_count: TIntegerField;
    qryRelatorioProdutosClientesfone: TStringField;
    qryRelatorioProdutosClientes_fone: TStringField;
    qryRelatorioProdutosVendedorescreditotroca: TFloatField;
    qryRelatorioProdutosClientescreditotroca: TFloatField;
    ...
    procedure qryEnderecoClienteBeforeOpen(DataSet: TDataSet);
    procedure qryRelatorioProdutosClientesBeforeOpen(DataSet: TDataSet);
    procedure qryRelatorioProdutosVendedoresBeforeOpen(DataSet: TDataSet);
  private
    ...
    procedure SetIncluirDevolucoesSemContrato(const Value: Boolean);
  ...
  public
    ...
    property IncluirDevolucoesSemContrato: Boolean read fIncluirDevolucoesSemContrato write SetIncluirDevolucoesSemContrato;
  ...
  case FParametroTipoRelatorio of
   0 : begin
        ...
        begin
        {
          ...
          frmPreview.frCompositeReport.Dataset := fdsRelatorioProdutosClientes_;
          frmPreview.frCompositeReport.Reports.Add(frpRelatorioProdutosClientes);
          frmPreview.frCompositeReport.DoublePass := False;
         ...
         {ATENÇÃO: A montagem da composição abaixo não funcionou, similar a prestações em aberto, esta funciona....paliativo abaixo para liberar para o cliente}
//          frpRelatorioProdutosClientes.DesignReport;
//          frpRelatorioProdutosClientes_Modelo_Gama.DesignReport;

          if PrecoPauta then
//            ImprimirRelatoriofast(null, null, MSimples, 0, [frpRelatorioProdutosClientes], false, self, fdsRelatorioProdutosClientes_)
             frpRelatorioProdutosClientes.ShowReport
          else
          begin
//             frpRelatorioProdutosClientes_Modelo_Gama.designreport;
//            ImprimirRelatoriofast(null, null, MSimples, 0, [frpRelatorioProdutosClientes_Modelo_Gama], false, self);
             frpRelatorioProdutosClientes_Modelo_Gama.ShowReport;
          end;
...
//            ImprimirRelatoriofast(null, null, MSimples, 0, [frpRelatorioProdutosClientes_SemValores], false, self)
           frpRelatorioProdutosClientes_SemValores.showReport
          else
//            ImprimirRelatoriofast(null, null, MSimples, 0, [frpRelatorioProdutosClientes_SemValores_Modelo_Gama], false, self);
           frpRelatorioProdutosClientes_SemValores_Modelo_Gama.ShowReport;
        end;
       end;
   1 : begin
...
begin
  ...
  case FParametroTipoRelatorio of
    0: begin
        ...
        qryRelatorioProdutosClientes_.sql.text := qryRelatorioProdutosClientes.sql.text;
        qryRelatorioProdutosClientes_.params := qryRelatorioProdutosClientes.params;
        qryRelatorioProdutosClientes_.macros := qryRelatorioProdutosClientes.macros;

        qryEnderecoCliente.open;
        qryRelatorioProdutosClientes.open;

        qryRelatorioProdutosClientes_.Open;
...
procedure TdtmRelatorioProdutosporClienteeVendedor.SetIncluirDevolucoesSemContrato(
  const Value: Boolean);
begin
  fIncluirDevolucoesSemContrato := Value;

end;

procedure TdtmRelatorioProdutosporClienteeVendedor.qryEnderecoClienteBeforeOpen(
  DataSet: TDataSet);
begin
  inherited;
  qryEnderecoCliente.ParamByName('IncluirDevolucoesSemContrato').asBoolean :=
    IncluirDevolucoesSemContrato;
end;

procedure TdtmRelatorioProdutosporClienteeVendedor.qryRelatorioProdutosClientesBeforeOpen(
  DataSet: TDataSet);
begin
  inherited;
  qryRelatorioProdutosClientes.ParamByName('IncluirDevolucoesSemContrato').asBoolean :=
    IncluirDevolucoesSemContrato;

end;

procedure TdtmRelatorioProdutosporClienteeVendedor.qryRelatorioProdutosVendedoresBeforeOpen(
  DataSet: TDataSet);
begin
  inherited;
  qryRelatorioProdutosVendedores.ParamByName('IncluirDevolucoesSemContrato').asBoolean :=
    IncluirDevolucoesSemContrato;
end;
