inherited frmVendasporFornecedor: TfrmVendasporFornecedor
  Left = 170
  Top = 123
  ...
  object pnlFundoJanela: TPanel
    ...
    object pgcConsulta: TPageControl
                  ...
                  inherited fraSelecaoAleatoriaItemdeProduto: TfraSelecaoAleatoria
                    ...
                    inherited pnlAbaixo: TPanel
                      ...
                      inherited lblOrientacao: TLabel
                        ...
                        Width = 265
                        Height = 15
                        Caption = '[Ctrl]+[F9] para procurar e [Ctrl]+[Del] para excluir'
                        Font.Height = -12
                        Font.Name = 'Helvetica'
                        Font.Pitch = fpVariable
                      end
                ...
                inherited fraSelecaoAleatoriaprodutos: TfraSelecaoAleatoriaprodutos
                  ...
                  inherited fraSelecaoAleatoriaProduto: TfraSelecaoAleatoria
                    ...
                    inherited pnlLabels: TPanel
                      ...
                      Align = alRight
                      inherited sbnProcura: TSpeedButton
                        Hint = 'CTRL+F9 - Procurar produto'
                      end
                      inherited sbnExcluir: TSpeedButton
                        Hint = 'CTL+Del - Excluir produto'
                      end
                      inherited sbnExcluirTodos: TSpeedButton
                        Hint = 'Excluir todos os produtos'
                      end
                ...
                inherited fraSelecaoaleatoriagruposprodutos: TfraSelecaoaleatoriagruposprodutos
                  inherited fraSelecaoAleatoriaGrupoProduto: TfraSelecaoAleatoria
                    ...
                    inherited pnlLabels: TPanel
                      Left = 673
                      inherited sbnProcura: TSpeedButton
                        Hint = 'CTRL+F9 - Procurar grupo'
                      end
                      inherited sbnExcluir: TSpeedButton
                        Top = 44
                        Hint = 'CTL+Del - Excluir grupo'
                      end
                      inherited sbnExcluirTodos: TSpeedButton
                        Hint = 'Excluir todos os grupos'
                      end
                      inherited sbnIncluirItem: TSpeedButton
                        Hint = 'Incluir grupo'
                      end
                ...
                inherited fraSelecaoaleatoriaclassesprodutos: TfraSelecaoaleatoriaclassesprodutos
                  inherited fraSelecaoAleatoriaClasseProduto: TfraSelecaoAleatoria
                    ...
                    inherited pnlLabels: TPanel
                      Left = 673
                      inherited sbnProcura: TSpeedButton
                        Hint = 'CTRL+F9 - Procurar classe'
                      end
                      inherited sbnExcluir: TSpeedButton
                        Hint = 'CTL+Del - Excluir classe'
                      end
                      inherited sbnExcluirTodos: TSpeedButton
                        Hint = 'Excluir todas as classes'
                      end
                      inherited sbnIncluirItem: TSpeedButton
                        Hint = 'Incluir classe'
                      end
                ...
                inherited fraSelecaoAleatoriamarcasProdutos: TfraSelecaoAleatoriamarcasProdutos
                  inherited fraSelecaoAleatoriamarcasProduto: TfraSelecaoAleatoria
                    ...
                    inherited pnlLabels: TPanel
                      Left = 673
                      inherited sbnProcura: TSpeedButton
                        Hint = 'CTRL+F9 - Procurar marca'
                      end
                      inherited sbnExcluir: TSpeedButton
                        Hint = 'CTL+Del - Excluir marca'
                      end
                      inherited sbnExcluirTodos: TSpeedButton
                        Hint = 'Excluir todos as marcas'
                      end
                      inherited sbnIncluirItem: TSpeedButton
                        Hint = 'Incluir marca'
                      end
                ...
                inherited fraSelecaoaleatoriapromocoes: TfraSelecaoaleatoriapromocoes
                  inherited fraSelecaoAleatoriapromocoes: TfraSelecaoAleatoria
                    ...
                    inherited pnlLabels: TPanel
                      Left = 673
                      inherited sbnProcura: TSpeedButton
                        Hint = 'CTRL+F9 - Procurar promo'#231#227'o'
                      end
                      inherited sbnExcluir: TSpeedButton
                        Hint = 'CTL+Del - Excluir promo'#231#227'o'
                      end
                      inherited sbnExcluirTodos: TSpeedButton
                        Hint = 'Excluir todas as promo'#231#245'es'
                      end
                      inherited sbnIncluirItem: TSpeedButton
                        Hint = 'Incluir promo'#231#227'o'
                      end
                    end
                    inherited pnlAbaixo: TPanel
                      Font.Pitch = fpVariable
      ...
      object tstConsulta: TTabSheet
        ...
        ImageIndex = 1
        TabVisible = False
        object dbgFornecedores: TtecDBGrid
          Left = 0
          Top = 0
          Width = 1119
          Height = 108
          Align = alTop
          DataSource = dtmVendasporFornecedor.dsrFornecedores
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
        ...
        object dbgProdutos: TtecDBGrid
          ...
          Height = 500
          Align = alClient
          DataSource = dtmVendasporFornecedor.dsrVendasporFornecedores
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
          ...
          Columns = <
            ...
            item
              ...
              Title.Alignment = taCenter
              Title.Caption = 'PRE'#199'O DE COMPRA'
              Width = 64
              Visible = True
            end
            item
              ...
              Title.Caption = 'TOTAL PRE'#199'O DE COMPRA'
              Width = 64
              Visible = True
            end
            item
