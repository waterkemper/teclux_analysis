inherited frmCadastroServicosOrdemServico: TfrmCadastroServicosOrdemServico
  Left = 700
  Top = 215
  Caption = 'Cadastro de Servi'#231'os da OS'
  ClientHeight = 257
  ClientWidth = 519
  PixelsPerInch = 96
  TextHeight = 16
  ...
  object pnlFundoJanela: TPanel
    ...
    object gbxFundoJanela: TGroupBox
      ...
      object gbxServico: TGroupBox
        ...
        ParentFont = False
        TabOrder = 0
        object sbnProcuraServicos: TSpeedButton
          Left = 55
          Top = 10
          Width = 23
          Height = 23
          Hint = 'Procura Servi'#231'os'
          Flat = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
          ...
          NumGlyphs = 2
          ParentFont = False
          OnClick = sbnProcuraServicosClick
        end
        object flkServico: TtecDBFindLookup
          Left = 2
          Top = 10
          Width = 52
          Height = 24
          ...
          LookupField = 'codigo'
          LookupSource = dtmordemservico.dsrProcuraServico
        ...
        object dtxDescricaoServico: TtecDBText
          Left = 79
          Top = 10
          Width = 420
          Height = 24
          ...
          Color = clBtnFace
          DataField = 'descricao'
          DataSource = dtmordemservico.dsrProcuraServico
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
          Font.Name = 'helvetica'
      ...
      object gbxAliquotaISS: TGroupBox
        Left = 278
        Top = 45
        Width = 69
        Height = 36
        Caption = 'AL'#205'Q. ISS'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -9
        Font.Name = 'helvetica'
