inherited frmComplementarNotaFiscalSaida: TfrmComplementarNotaFiscalSaida
  Left = 906
  Top = 105
  ActiveControl = flkFornecedorTransporte
  BorderStyle = bsSingle
  Caption = 'Complemento do dado fiscal'
  ClientHeight = 400
  ClientWidth = 530
  PixelsPerInch = 96
  TextHeight = 16
  object pnlFundoJanela: TPanel
    ...
    object gbxFundoJanela: TGroupBox
      ...
      object lblFornecedorTransporte: TLabel
        Left = 6
        Top = 38
        Width = 79
        Height = 16
      ...
      object lblEspecieTransporte: TLabel
        Left = 38
        Top = 119
        Width = 47
        Height = 16
      ...
      object flkFornecedorTransporte: TtecDBFindLookup
        ...
        DataSource = dtmCadastroContratos.dsrDadosFiscais
        MaxLength = 8
        Maximo = 0
        Minimo = 37353
        Adicional = 0
        ...
        LookupField = 'codigo'
        LookupSource = dtmCadastroContratos.dsrProcuraFornecedorTransporte
      ...
      object edtPesoBruto: TDBEditNumero
        ...
        Tamanho = 11
        DataField = 'pesobruto'
        DataSource = dtmCadastroContratos.dsrVolumesDadosFiscais
      end
      ...
      object edtEspecie: TDBEditTexto
        Left = 90
        Top = 116
        Width = 101
        Height = 24
      ...
      object dtxNomeFornecedorTransporte: TtecDBText
        ...
        Color = clBtnFace
        DataField = 'razao'
        DataSource = dtmCadastroContratos.dsrProcuraFornecedorTransporte
        ReadOnly = True
        TabOrder = 14
        Alignment = taLeftJustify
      end
      ...
      object flkEstadoPlaca: TtecDBFindLookup
        ...
        Operacao = opATRIBUICAO
        LookupField = 'codigo'
        LookupSource = dtmCadastroContratos.dsrProcuraEstadoPlaca
        LookupQueryParameter = 'codigo'
        Parameter = ' '
        ActiveSetControls = False
        DenyInsert = False
      ...
      object dtxEstadoPlaca: TtecDBText
        Left = 283
        Top = 61
        Width = 232
        Height = 24
        ...
        Color = clBtnFace
        DataField = 'nome'
        DataSource = dtmCadastroContratos.dsrProcuraEstadoPlaca
        ReadOnly = True
        TabOrder = 17
        Alignment = taLeftJustify
      end
