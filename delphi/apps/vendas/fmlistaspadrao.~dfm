inherited frmListasPadrao: TfrmListasPadrao
  Left = 703
  Top = 147
  Action = actHabilitar
  ...
  inherited pnlTopMenu: TPanel
    ...
    inherited tblBarraCadastro: TToolBar
      Width = 300
      object sbnImprimirListaPadrao: TSpeedButton
        Left = 225
        Top = 2
        Width = 75
        Height = 39
        Hint = 'Imprimir Lista Padr'#227'o'
        Caption = 'Imprimir F7'
        Flat = True
        Glyph.Data = {
        ...
        Layout = blGlyphTop
        Spacing = 0
        OnClick = sbnImprimirListaPadraoClick
      end
    end
  end
  object pnlFundoJanela: TPanel
    ...
    object gbxProdutos: TGroupBox
      ...
      object dbgProdutos: TtecDBGrid
        ...
        Height = 467
        Align = alClient
        DataSource = dtmListasPadrao.dsrProdutosListasPadrao
        Font.Charset = DEFAULT_CHARSET
    ...
    object pnlTop: TPanel
      ...
      object gbxCodigo: TGroupBox
        ...
        object edfCodigo: TtecDbEditFind
          ...
          DataField = 'codigo'
          DataSource = dtmListasPadrao.dsrListasPadrao
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
      ...
      object gbxOpcoes: TGroupBox
        ...
        Caption = 'Imprimir'
        TabOrder = 5
        object ckbImprimirPrecos: TCheckBox
          Left = 8
          Top = 22
          Width = 78
          Height = 14
      ...
      object gbxVendedor: TGroupBox
        ...
        inline fraConsultaVendedor: TfraConsultaCodigo
          ...
          inherited dtxDescricao: TtecDBText
            ...
            Width = 521
            DataField = 'nome'
            DataSource = fraConsultaVendedor.dsrProcuraUsuarios
          end
          inherited edfCodigo: TtecDBFindLookup
            Width = 57
            DataField = 'usuario'
            ...
            MaxLength = 6
            LookupField = 'codigo'
            LookupSource = fraConsultaVendedor.dsrProcuraUsuarios
            LookupQueryParameter = 'codigo'
            Parameter = ' '
            ActiveSetControls = False
            DenyInsert = True
