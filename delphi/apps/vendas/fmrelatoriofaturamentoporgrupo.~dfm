inherited frmRelatoriofaturamentoporgrupo: TfrmRelatoriofaturamentoporgrupo
  Left = 282
  Top = 146
  ActiveControl = pgcFilialGrupoFilial
  Caption = 'Relat'#243'rio de Faturamento por Grupos'
  ClientHeight = 515
  ClientWidth = 971
  ...
  PixelsPerInch = 96
  TextHeight = 16
  object sbnItemProduto: TSpeedButton [0]
    Left = 127
    Top = 20
    Width = 23
    Height = 23
  ...
  inherited pnlFundoJanela: TPanel
    ...
    object gbxVendedor: TGroupBox
      ...
      object edfVendedor: TtecDbEditFind
        ...
        DataField = 'codigo'
        DataSource = dtmRelatoriofaturamentoporgrupo.dsrProcuraVendedores
        Group = 'Vendedor'
        MaxLength = 3
        Maximo = 0
        Minimo = 37353
    ...
    object gbxAgrupamento: TGroupBox
      ...
      object ckbAgruparClasse: TCheckBox
        Left = 5
        Top = 40
        Width = 93
        Height = 25
    ...
    object rgbxOrdenacao: TRadioGroup
      Left = 716
      Top = 322
      Width = 137
      Height = 148
