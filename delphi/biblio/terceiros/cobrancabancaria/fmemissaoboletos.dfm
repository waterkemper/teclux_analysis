  ...
  object qryParcelas: TtecQuery
    ...
    Sql.Strings = (
      ...
      '       f.rua                          as Cedente_Endereco_Rua,'
        ...
        '       f.complemento                  as Cedente_Endereco_Comple' +
        'mento,'
    ...
    object qryParcelascedente_endereco_numero: TIntegerField
      FieldName = 'cedente_endereco_numero'
    end
    object qryParcelascedente_endereco_complemento: TStringField
      FieldName = 'cedente_endereco_complemento'
      Size = 100
    end
    object qryParcelassacado_endereco_numero: TIntegerField
      FieldName = 'sacado_endereco_numero'
    end
    object qryParcelassacado_endereco_complemento: TStringField
