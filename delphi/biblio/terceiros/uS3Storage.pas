...
type
  ...
  function GetAuthString_(verb: string; MD5: string; ContentType: string; sDate: string; Request: string; pPublicKey: String): string;
...
//return auth string
  Result := 'Authorization: AWS ' + pPublicKey + ':' + sBase64;
