inherited frmAnaliseFalhasMaquinasSetores: TfrmAnaliseFalhasMaquinasSetores
  Left = 467
  Top = 199
  ActiveControl = dbgAnaliseFalhasMaquinasSetores
  AutoSize = True
  ...
  object pgcAnaliseFalhasMaquinasSetores: TPageControl
    Left = 0
    Top = 40
    Width = 1149
    Height = 349
    ...
    object tstSelecao: TTabSheet
      ...
      object rgbTipoIndices: TtecDBRadioGroup
        ...
        TabOrder = 2
        TabStop = False
        object rbnMaquinasXFalhas: TtecRadioButton
          Left = 8
          Top = 14
          Width = 125
          Height = 17
          Caption = 'M'#225'quinas x Falhas'
          Checked = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
        ...
        object rbnSetores_x_Falhas: TtecRadioButton
          Left = 8
          Top = 32
          Width = 125
          Height = 17
          Caption = 'Setores x Falhas'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
          Font.Name = 'helvetica'
      ...
      object gbxFalhas: TGroupBox
        ...
        ParentFont = False
        TabOrder = 4
        inline fraSelecaoAleatoriaFalhas: TfraSelecaoAleatoria
          Left = 2
          Top = 16
          Width = 366
          Height = 211
          ...
          inherited dbgSelecaoAleatoria: TtecDBGrid
            ...
            Font.Height = -12
            Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgCancelOnExit]
            OnDblClick = fraSelecaoAleatoriaFalhasdbgSelecaoAleatoriaDblClick
            OnKeyDown = fraSelecaoAleatoriaFalhasdbgSelecaoAleatoriaKeyDown
            CanDelete = True
          end
          inherited pnlLabels: TPanel
            Left = 335
            Height = 198
            inherited sbnProcura: TSpeedButton
              OnClick = fraSelecaoAleatoriaFalhassbnProcuraClick
            end
          end
          inherited pnlAbaixo: TPanel
            Top = 198
          ...
          inherited qrySelecaoAleatoria: TtecQuery
            AfterOpen = fraSelecaoAleatoriaFalhasqrySelecaoAleatoriaAfterOpen
            Sql.Strings = (
    ...
    object tstDados: TTabSheet
      Caption = 'Dados'
      ImageIndex = 1
      object dbgAnaliseFalhasMaquinasSetores: TtecDBGrid
        Left = 0
        Top = 0
        Width = 1141
        Height = 319
        Align = alClient
        DataSource = dtmAnaliseFalhasMaquinasSetores.dsrAnaliseFalhas
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -9
        Font.Name = 'MS Sans Serif'
