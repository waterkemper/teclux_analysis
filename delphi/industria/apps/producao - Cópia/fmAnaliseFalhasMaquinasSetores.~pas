...
procedure TfrmAnaliseFalhasMaquinasSetores.AtribuirDadosMaquinas;
begin
  with fraSelecaoAleatoriaMaquinas do
  begin
...
procedure TfrmAnaliseFalhasMaquinasSetores.AtribuirDadosSetoresProducao;
begin
  with fraSelecaoAleatoriaSetoresdeProducao do
  begin
    qrySelecaoAleatoria.Edit;
...
procedure TfrmAnaliseFalhasMaquinasSetores.AtribuirDadosFalhas;
begin
  with fraSelecaoAleatoriaFalhas do
  begin
    qrySelecaoAleatoria.Edit;
