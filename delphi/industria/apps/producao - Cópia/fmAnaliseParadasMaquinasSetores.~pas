...
procedure TfrmAnaliseParadasMaquinasSetores.AtribuirDadosMaquinas;
begin
  with fraSelecaoAleatoriaMaquinas do
  begin
...
procedure TfrmAnaliseParadasMaquinasSetores.AtribuirDadosSetoresProducao;
begin
  with fraSelecaoAleatoriaSetoresdeProducao do
  begin
    qrySelecaoAleatoria.Edit;
...
procedure TfrmAnaliseParadasMaquinasSetores.AtribuirDadosParadas;
begin
  with fraSelecaoAleatoriaParadas do
  begin
    qrySelecaoAleatoria.Edit;
