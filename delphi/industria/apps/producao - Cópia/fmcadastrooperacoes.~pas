...
//    ConsultaTemposPadrao: TfraConsultaCodigo;
    ...
    procedure AbrirOperacoes;
    procedure AtribuirDadosOperacoesNiveisSalariais;
...
procedure TfrmCadastroOperacoes.AbrirOperacoes;
begin
...
procedure TfrmCadastroOperacoes.AtribuirDadosOperacoesNiveisSalariais;
begin
...
begin
  ...
  if not ConsultaNiveisSalariais.qryProcuraNivelSalarial.IsEmpty then
    AtribuirDadosOperacoesNiveisSalariais
  else
  begin
    result := false;
    dbgOperacoesNiveisSalariais.SetFocus;
...
procedure TfrmCadastroOperacoes.AtribuirDadosFalhasOperacoes;
begin
...
procedure TfrmCadastroOperacoes.AtribuirDadosMaquinas;
begin
  with dtmCadastroOperacoes do
  begin
