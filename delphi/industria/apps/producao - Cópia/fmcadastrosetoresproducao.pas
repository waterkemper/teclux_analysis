...
type
  ...
  private
    ...
    procedure AtribuirDadosUsuariosLideres;
...
procedure TfrmCadastroSetoresProducao.AbrirMotivoParadas;
begin
...
procedure TfrmCadastroSetoresProducao.AtribuirDadosUsuariosLideres;
begin
