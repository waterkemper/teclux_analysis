inherited frmindicenaoqualidade: Tfrmindicenaoqualidade
  Left = 389
  Top = 338
  ...
  object pgcindicenaoqualidade: TPageControl
    Left = 0
    Top = 40
    Width = 884
    Height = 355
    ...
    object tstSelecao: TTabSheet
      ...
      object rgbTipoEficiencia: TtecDBRadioGroup
        ...
        TabOrder = 1
        TabStop = False
        object rbn_Custo_nao_qualidade: TtecRadioButton
          Left = 8
          Top = 16
          Width = 215
          Height = 17
          Caption = 'Custo da n'#227'o qualidade'
          Checked = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
          ...
          TabOrder = 0
          TabStop = True
          OnClick = rbn_Custo_nao_qualidadeClick
        end
        object rbn_PPM: TtecRadioButton
          Left = 8
          Top = 32
          Width = 215
          Height = 17
          ...
          ParentFont = False
          TabOrder = 1
          OnClick = rbn_PPMClick
        end
        object rbnPN_PPM_Custos: TtecRadioButton
          Left = 8
          Top = 48
          Width = 215
          Height = 17
          Caption = 'PN + PPM + Custos n'#227'o qualidade'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
          Font.Name = 'helvetica'
    ...
    object tstDados: TTabSheet
      ...
      ImageIndex = 1
      object dbgindicenaoqualidade: TtecDBGrid
        Left = 0
        Top = 0
        Width = 876
        Height = 325
        Align = alClient
        DataSource = dtmindicenaoqualidade.dsrindicenaoqualidade
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
        Font.Name = 'Helvetica'
