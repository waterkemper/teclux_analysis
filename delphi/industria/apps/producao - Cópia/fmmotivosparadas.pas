...
type
  ...
  private
    ...
    procedure AtribuirDadosMotivosParadas;
...
procedure Tfrmmotivosparadas.AtribuirDadosFuncionarios;
begin
  with fraSelecaoAleatoriaFuncionarios do
  begin
...
procedure Tfrmmotivosparadas.AtribuirDadosSetoresProducao;
begin
  with fraSelecaoAleatoriaSetoresdeProducao do
  begin
    qrySelecaoAleatoria.Edit;
...
procedure Tfrmmotivosparadas.AtribuirDadosMaquinas;
begin
  with fraSelecaoAleatoriaMaquinas do
  begin
    qrySelecaoAleatoria.Edit;
...
procedure Tfrmmotivosparadas.AtribuirDadosMotivosParadas;
begin
  with fraSelecaoAleatoriaMotivosParadas do
  begin
    qrySelecaoAleatoria.Edit;
