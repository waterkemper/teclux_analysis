unit fmrelatorioEvolucaoPrecos;
...
type
  TfrmRelatorioEvolucaoPrecos = class(TfrmRelatorioPadrao)
    ...
    pgcRelatorioEvolucaoPrecos: TPageControl;
  ...
  private
    ...
    procedure AtribuirDadosGruposdeProdutos;
...
var
  frmRelatorioEvolucaoPrecos: TfrmRelatorioEvolucaoPrecos;
...
procedure TfrmRelatorioEvolucaoPrecos.AcionarPesquisaGruposdeProdutos;
begin
...
procedure TfrmRelatorioEvolucaoPrecos.AtribuirDadosClientes;
begin
...
procedure TfrmRelatorioEvolucaoPrecos.AtribuirDadosGruposdeProdutos;
begin
  with fraSelecaoAleatoriaGruposdeProdutos do
  begin
    qrySelecaoAleatoria.Edit;
...
constructor TfrmRelatorioEvolucaoPrecos.Create(Aowner: Tcomponent);
begin
  dtmRelatorioEvolucaoPrecos := TdtmRelatorioEvolucaoPrecos.Create(Self);
  inherited;
...
destructor TfrmRelatorioEvolucaoPrecos.Destroy;
begin

  inherited;
end;

procedure TfrmRelatorioEvolucaoPrecos.fraSelecaoAleatoriaClientesqrySelecaoAleatoriaAfterOpen(DataSet: TDataSet);
var nc: integer;
begin
  inherited;
...
procedure TfrmRelatorioEvolucaoPrecos.fraSelecaoAleatoriaGruposdeProdutosqrySelecaoAleatoriaAfterOpen(DataSet: TDataSet);
var nc: integer;
begin
  inherited;
...
procedure TfrmRelatorioEvolucaoPrecos.fraSelecaoAleatoriaGruposdeProdutossbnProcuraClick(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmRelatorioEvolucaoPrecos.fraSelecaoAleatoriaGruposdeProdutosdbgSelecaoAleatoriaDblClick(
  Sender: TObject);
begin
  inherited;
  AcionarPesquisaGruposdeProdutos;
...
procedure TfrmRelatorioEvolucaoPrecos.fraSelecaoAleatoriaGruposdeProdutosdbgSelecaoAleatoriaKeyDown(
  Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TfrmRelatorioEvolucaoPrecos.fraSelecaoAleatoriaClientessbnProcuraClick(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmRelatorioEvolucaoPrecos.AcionarPesquisaClientes;
begin
  with fraSelecaoAleatoriaClientes do
  begin
    dbgSelecaoAleatoria.SetFocus;
...
procedure TfrmRelatorioEvolucaoPrecos.fraSelecaoAleatoriaClientessbnIncluirItemClick(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmRelatorioEvolucaoPrecos.fraSelecaoAleatoriaClientesdbgSelecaoAleatoriaDblClick(
  Sender: TObject);
begin
  inherited;
  AcionarPesquisaClientes;
...
procedure TfrmRelatorioEvolucaoPrecos.fraSelecaoAleatoriaClientesdbgSelecaoAleatoriaKeyDown(
  Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Shift = [ssCtrl] then
  begin
...
procedure TfrmRelatorioEvolucaoPrecos.sbnGerarClick(
  Sender: TObject);
begin
  inherited;
  if ValidarCamposSelecao then
  begin
    if dtmRelatorioEvolucaoPrecos.AbrirConsulta(edtDataInicial.Text, edtDataFinal.Text,
                                            fraSelecaoAleatoriaClientes.StringSelecionada,
                                            fraSelecaoAleatoriaGruposdeProdutos.StringSelecionada) then
      pgcRelatorioEvolucaoPrecos.ActivePage := tstDados
  end;
end;

function TfrmRelatorioEvolucaoPrecos.ValidarCamposSelecao: Boolean;
begin
  result := ecvValida.Verify(tstParametros, ControleValido);
end;

procedure TfrmRelatorioEvolucaoPrecos.InternoImpressao;
begin
  inherited;
  dtmRelatorioEvolucaoPrecos.ExportarExcel; 
end;

procedure TfrmRelatorioEvolucaoPrecos.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case key of
