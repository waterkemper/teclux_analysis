inherited frmtempousuariosetor: Tfrmtempousuariosetor
  Left = 868
  Top = 268
  ActiveControl = edtdatainicial
  Caption = 'Tempo por Usu'#225'rios/Setor'
  ClientHeight = 353
  ClientWidth = 894
  ...
  object pgctempousuariosetor: TPageControl
    Left = 0
    Top = 40
    Width = 894
    Height = 313
    ...
    object tstDados: TTabSheet
      ...
      ImageIndex = 1
      object dbgtempousuariosetor: TtecDBGrid
        Left = 0
        Top = 0
        Width = 886
        Height = 283
        Align = alClient
        DataSource = dtmtempousuariosetor.dsrtempousuariosetor
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
        Font.Name = 'Helvetica'
