inherited frmFCI: TfrmFCI
  ...
  object dbgfci: TtecDBGrid
    Left = 177
    Top = 40
    Width = 839
    Height = 502
    Align = alClient
    DataSource = dtmFCI.dsrFCI
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -9
    Font.Name = 'helvetica'
    ...
    TitleFont.Style = []
    OnDrawColumnCell = dbgFCIDrawColumnCell
    RowWrap = 60
    Large = False
