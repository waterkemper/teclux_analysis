inherited frmCadastroInstrucoes: TfrmCadastroInstrucoes
  Left = 759
  Top = 219
  ActiveControl = edfInstrucao
  Caption = 'Cadastro de Instru'#231#245'es de Trabalho'
  ClientHeight = 522
  ClientWidth = 795
  ...
  inherited pnlBarra: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object tstCadastro: TTabSheet
        Caption = ' Cadastro'
        object lblInatividadeMaxima: TLabel
          Left = 570
          Top = 0
          Width = 95
          Height = 12
          Hint = 
            'N'#186' de meses que um operador pode ficar sem atuar numa opera'#231#227'o d' +
            'a Instru'#231#227'o de Trabalho para ser considerado inabilitado'
          Caption = 'INATIVIDADE M'#193'XIMA'
        ...
        object gbxNomeInstrucao: TGroupBox
          Left = 179
          Top = 12
          Width = 386
          Height = 36
          Caption = 'DESCRI'#199#195'O DA INSTRU'#199#195'O DE TRABALHO '
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -9
          Font.Name = 'helvetica'
          ...
          object edtDescricao: TDBEditTexto
            ...
            Height = 23
            DataField = 'descricao'
            DataSource = dtmCadastroInstrucoes.dsrInstrucoes
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlack
            Font.Height = -12
            Font.Name = 'helvetica'
        ...
        object gbxOperacoes: TGroupBox
          ...
          Width = 776
          Height = 396
          Caption = ' OPERA'#199#213'ES CONSTANTES DA INSTRU'#199#195'O DE TRABALHO'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          Font.Name = 'helvetica'
          ...
          object dbgOperacoes: TtecDBGrid
            ...
            Height = 378
            Align = alClient
            DataSource = dtmCadastroInstrucoes.dsrInstrucoesTrabalhoOperacoes
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlack
            Font.Height = -11
            Font.Name = 'helvetica'
        ...
        object gbxInstrucao: TGroupBox
          ...
          Width = 174
          Height = 36
          Caption = 'INSTRU'#199#195'O DE TRABALHO '
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -9
          Font.Name = 'helvetica'
          ...
          ParentFont = False
          TabOrder = 0
          object edfInstrucao: TtecDBFindLookup
            Left = 4
            Top = 11
            Width = 166
            Height = 23
            ...
            NoSetControls = <
              item
                Control = gbxInstrucao
              end>
            SetControls = <
              item
                Control = gbxNomeInstrucao
              end
              item
        ...
        object gbxInatividadeMaxima: TGroupBox
          Left = 570
          Top = 12
          Width = 96
          Height = 36
          ...
          object edtInatividadeMaxima: TDBEditNumero
            Left = 2
            Top = 10
            Width = 36
            Height = 23
      ...
      object tstLog: TTabSheet
        ...
        inline fraRegistroOperacoes1: TfraRegistroOperacoes
          ...
          inherited dsrRegistrodasOperacaoes: TtecDataSource
            DataSet = dtmCadastroInstrucoes.qryRegistrodasOperacoes
          end
        end
      end
    end
