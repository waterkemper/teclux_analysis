...
//    procedure AfterScrollInternet(Sender: TObject);
  protected
    ...
    procedure AbrirOperadores(Found: Boolean);
//    procedure AlterarEstadoBotoes; override;
//    function  InternoIncluir   : Boolean;    override;
    function  InternoGravar    : Boolean;    override;
    procedure AtribuirDadosinstrucaoProducao(Found: Boolean);
...
procedure TfrmCadastroOperadores.AtribuirDadosinstrucaoProducao(Found: Boolean);
begin
...
procedure TfrmCadastroOperadores.AtribuirDadosNiveisConhecimento(Found: Boolean);
begin
  with dtmCadastroOperadores do
  begin
    EditarUsuariosinstrucaoProducao;
...
begin
  ...
  begin
    ...
    if not ConsultaInstrucoes.qryProcuraInstrucoesTrabalho.IsEmpty then
      AtribuirDadosinstrucaoProducao(true)
    else
    begin
      result := false;
      dbgOperacoesdeProducao.SetFocus;
...
procedure TfrmCadastrooperadores.AbrirOperadores(Found: Boolean);
begin
