...
type
  ...
  protected
    ...
    procedure AbrirFalhas(Found: Boolean);
    ...
    procedure AtribuirDadosFalhaOriginal(Found: Boolean);

    procedure AtribuirDadosOperacoes(Found: Boolean);
...
procedure TfrmCadastroFalhas.AbrirFalhas(Found: Boolean);
begin
...
procedure TfrmCadastroFalhas.AtribuirDadosFalhasOperacoes(Found: Boolean);
begin
...
//  ConsultaOperacoes.edfCodigo.DoExit;
  ...
  if not ConsultaOperacoes.qryProcuraOperacoes.IsEmpty then
    AtribuirDadosFalhasOperacoes(true)
  else
  begin
...
procedure TfrmCadastroFalhas.AtribuirDadosOperacoes(Found: Boolean);
begin
  with dtmCadastroFalha do
  begin
...
procedure TfrmCadastroFalhas.AtribuirDadosFalhaOriginal(Found: Boolean);
begin
  with dtmCadastroFalha do
  begin
    EditarFalhasOperacoes;
