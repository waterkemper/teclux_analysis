...
type
  ...
  protected
    ...
    procedure AbrirFluxoGrama(Found: Boolean);
    procedure AtribuirDadosFluxoGramasOperacoes(Found: Boolean);
...
procedure TfrmCadastroFluxoGramas.AbrirFluxoGrama(Found: Boolean);
begin
...
procedure TfrmCadastroFluxoGramas.AtribuirDadosFluxoGramasOperacoes(Found: Boolean);
begin
...
//  ConsultaOperacoes.edfCodigo.DoExit;
  ...
  if not ConsultaOperacoes.qryProcuraOperacoes.IsEmpty then
    AtribuirDadosFluxoGramasOperacoes(true)
  else
  begin
