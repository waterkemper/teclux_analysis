...
type
  ...
  protected
    ...
    procedure AbrirNivelSalarial(Found: Boolean);
...
procedure TfrmCadastroNiveisSalariais.AbrirNivelSalarial(Found: Boolean);
begin
...
procedure TfrmCadastroNiveisSalariais.AtribuirDadosUsuarios(Found: Boolean);
begin
