...
type
  ...
  private
    ...
    procedure AtribuirDadosUsuariosSetup(Found: Boolean);
    procedure AtribuirDadosUsuariosFechamento(Found: Boolean);
    ...
    procedure AtribuirDadosOperacoesosp(Found: Boolean);
...
procedure TfrmOperacoesOSP.AbrirOSP(Found: Boolean);
begin
...
//          dtmOperacoesOSP.GravarOperacoesOSPUsuario;
          ...
          begin
            ...
            AtribuirDadosUsuariosSetup(true);
            dbgOPeracoesOSPUsuario.SetFocus;
//            dbgOPeracoesOSPUsuario.SelectedIndex := 2;
          end;
       end;
...
//          dtmOperacoesOSP.GravarOperacoesOSPUsuario;
          ...
          begin
            ...
            AtribuirDadosUsuariosFechamento(true);
            dbgOPeracoesOSPUsuario.SetFocus;
//            dbgOPeracoesOSPUsuario.SelectedIndex := 5;
          end;
       end;
...
procedure TfrmOperacoesOSP.AtribuirDadosUsuarios(Found: Boolean);
begin
...
procedure TfrmOperacoesOSP.AtribuirDadosFalhas(Found: Boolean);
var
  vResult : boolean;
...
procedure TfrmOperacoesOSP.AtribuirDadosParadas(Found: Boolean);
begin
  with dtmOperacoesOSP do
  begin
...
procedure TfrmOperacoesOSP.AtribuirDadosUsuariosSetup(Found: Boolean);
begin
  with dtmOperacoesOSP do
  begin
...
procedure TfrmOperacoesOSP.AtribuirDadosUsuariosFechamento(Found: Boolean);
begin
  with dtmOperacoesOSP do
  begin
...
procedure TfrmOperacoesOSP.AtribuirDadosMaquinas(Found: Boolean);
begin
  with dtmOperacoesOSP do
  begin
    EditarOperacoesOSPUsuario;
...
procedure TfrmOperacoesOSP.AtribuirDadosOperacoesosp(Found: Boolean);
begin
  with dtmOperacoesOSP do
  begin
