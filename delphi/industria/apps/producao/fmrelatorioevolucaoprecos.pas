...
procedure TfrmRelatorioEvolucaoPrecos.AtribuirDadosClientes(Found: Boolean);
begin
...
procedure TfrmRelatorioEvolucaoPrecos.AtribuirDadosGruposdeProdutos(Found: Boolean);
begin
  with fraSelecaoAleatoriaGruposdeProdutos do
  begin
    qrySelecaoAleatoria.Edit;
