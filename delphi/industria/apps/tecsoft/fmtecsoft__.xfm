  ...
  object mmuTecsoft: TMainMenu
    ...
    object mitCaixa: TMenuItem
      ...
      object mitComandosECF: TMenuItem
        ...
        object mitLeituraMemriaFiscal: TMenuItem
          Tag = 1
          Caption = 'Leitura da &Mem'#243'ria Fiscal'
          object mitLeituraMemoriaFiscalData: TMenuItem
            Tag = 1
            Caption = 'Por &Data'
            OnClick = mitLeituraMemoriaFiscalDataClick
          end
          object mitLeituraMemoriaFiscalReducao: TMenuItem
            Tag = 1
            Caption = 'Por &Redu'#231#227'o'
            OnClick = mitLeituraMemoriaFiscalReducaoClick
          end
        end
      end
