inherited frmEmissaoNotasVenda: TfrmEmissaoNotasVenda
  Left = 309
  Top = 132
  Width = 897
  Height = 540
  ...
  Caption = 'Emiss'#227'o de Notas de Venda'
  ...
  object pgcNotasVenda: TPageControl
    Left = 0
    Top = 45
    Width = 877
    Height = 453
    ...
    object tstOSPs: TTabSheet
      ...
      object gbxOSP: TGroupBox
        ...
        object dbgProdutosDadosFiscais: TtecDBGrid
          ...
          Height = 288
          Align = alClient
          DataSource = dtmEmissaoNotasVenda.dsrProdutosDadosFiscais
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          Font.Name = 'helvetica'
          ...
          TitleFont.Style = []
          OnKeyDown = dbgProdutosDadosFiscaisKeyDown
          RowWrap = 60
          Large = False
          DoubleRowColor = False
          MsgDelete = 'este produto da OSP'
          TitleMinHeight = 100
          CellHeights = 100
        ...
        object gbxQtdesPedidos: TGroupBox
          Left = 540
          Top = 10
          Width = 301
          Height = 14
          Caption = 'Q U A N T I D A D E S    O S P'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -9
          Font.Name = 'helvetica'
      ...
      object pnlCabecalho: TPanel
        ...
        TabOrder = 1
        object pnlCabecalhoDireita: TPanel
          Left = 0
          Top = 0
          Width = 633
          Height = 133
          ...
          object gbxObservacoes: TGroupBox
            ...
            object mmoObservacoesCliente: TtecDBMemo
              Left = 2
              Top = 19
              Width = 624
              Height = 70
        ...
        object gbxNotaComplementar: TGroupBox
          Left = 635
          Top = 0
          Width = 130
          Height = 36
          Caption = 'COMPLEMENTAR DA NF:'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -9
          Font.Name = 'helvetica'
          ...
          ParentFont = False
          TabOrder = 1
          inline fraConsultaNotaFiscalComplementar: TfraConsultaCodigo
            Left = 4
            Top = 11
            Width = 123
            Height = 23
            ...
            inherited edfCodigo: TtecDBFindLookup
              Width = 98
              DataField = 'numeronfcomplementar'
              DataSource = dtmEmissaoNotasVenda.dsrDadosFiscais
              MaxLength = 6
              OnEnter = fraConsultaNotaFiscalComplementaredfCodigoEnter
              OnExit = fraConsultaNotaFiscalComplementaredfCodigoExit
              LookupField = 'numero'
              LookupSource = fraConsultaNotaFiscalComplementar.dsrprocuraNotas
        ...
        object ckbIPISuspenso: TDBCheckBox
          Left = 635
          Top = 36
          Width = 169
          Height = 31
          Caption = 'CLIENTE COM IPI SUSPENSO'
        ...
        object tstTransporte: TTabSheet
          ...
          object gbxPlaca: TGroupBox
            ...
            object edtPlacaTransporte: TDBEditTexto
              ...
              ParentFont = False
              TabOrder = 0
              OnKeyDown = edtPlacaTransporteKeyDown
