inherited frmConferenciaDocumentos: TfrmConferenciaDocumentos
  Left = 488
  Top = 83
  ...
  object dbgProdutos: TtecDBGrid
    ...
    Height = 506
    Align = alLeft
    DataSource = dsrVolumesDadosfiscaisConferencia
  ...
  object pnlTopo: TPanel
    ...
    object gbxPesquisaNFe: TGroupBox
      ...
      object edtNFE: TMaskEdit
        ...
        Height = 23
        EditMask = 
          '99\-9999\-99999999999999\-99\-999\-999999999\-9\-99999999\-9\-99' +
          '9\-999;0;_'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -12
  ...
  object qryVolumesDadosfiscaisConferencia: TtecQuery
    Tag = -1
    ...
    Constraints = <>
    BeforePost = qryVolumesDadosfiscaisConferenciaBeforePost
    OnCalcFields = qryVolumesDadosfiscaisConferenciaCalcFields
    OnNewRecord = qryVolumesDadosfiscaisConferenciaNewRecord
    ...
    Sql.Strings = (
      ...
      '       vdfc.nrvolume,'
      '       vdfc.conferido,'
      '       vdfc.conferidodigitado,'
      '       vdfc.datahora_inclusao,'
      '       vdfc.datahora_alteracao,'
      '       cast(df.chv_nfe||'
      '       lpad(cast(vdfc.nrvolume as varchar(3)),3,'#39'0'#39')||'
      
        '       lpad(cast(vdfc.volume as varchar(3)) ,3,'#39'0'#39') as varchar(5' +
        '0)) as chv_nfevolumes,'
      '       vdfc.usuario,'
      '       vdfc.filialregistro'
      ''
      ...
      ''
      'where vdfc.tipo = :tipo'
      '  and vdfc.codigo in (%codigo)'
      '    and df.situacao <> '#39'C'#39
      ''
      'order by df.data, n.numero, vdfc.volume')
    RequestLive = True
    Left = 376
    Top = 112
    ParamData = <
    ...
    object qryVolumesDadosfiscaisConferenciatipo: TStringField
      FieldName = 'tipo'
      Size = 3
    end
    object qryVolumesDadosfiscaisConferenciacodigo: TStringField
      FieldName = 'codigo'
    end
    object qryVolumesDadosfiscaisConferenciadadofiscal: TIntegerField
      FieldName = 'dadofiscal'
    end
    object qryVolumesDadosfiscaisConferenciafilial: TIntegerField
      DisplayLabel = 'FILIAL'
      FieldName = 'filial'
    end
    object qryVolumesDadosfiscaisConferenciaserie: TStringField
      DisplayLabel = 'S'#201'RIE'
      FieldName = 'serie'
      Size = 3
    end
    object qryVolumesDadosfiscaisConferencianumero: TIntegerField
      DisplayLabel = 'N'#218'MERO'
      FieldName = 'numero'
    end
    object qryVolumesDadosfiscaisConferenciachv_nfe: TStringField
      DisplayLabel = 'CHAVE NFE'
      FieldName = 'chv_nfe'
      EditMask = '99\-9999\-99999999999999\-99\-999\-999999999\-9\-99999999\-9;0;_'
      Size = 44
    end
    object qryVolumesDadosfiscaisConferenciavolume: TIntegerField
      DisplayLabel = 'NR'#176' VOLUME'
      FieldName = 'volume'
    end
    object qryVolumesDadosfiscaisConferencianrvolume: TIntegerField
      FieldName = 'nrvolume'
    end
    object qryVolumesDadosfiscaisConferenciaconferido: TBooleanField
      DisplayLabel = 'CONFERIDO'
      FieldName = 'conferido'
    end
    object qryVolumesDadosfiscaisConferenciaconferidodigitado: TBooleanField
      FieldName = 'conferidodigitado'
    end
    object qryVolumesDadosfiscaisConferenciachv_nfevolumes: TStringField
      FieldName = 'chv_nfevolumes'
      Size = 50
    end
    object qryVolumesDadosfiscaisConferenciavolumes: TStringField
      FieldKind = fkCalculated
      FieldName = 'volumes'
      Size = 7
      Calculated = True
    end
    object qryVolumesDadosfiscaisConferencianumerovolume: TIntegerField
      FieldName = 'numerovolume'
    end
    object qryVolumesDadosfiscaisConferenciadatahora_inclusao: TDateTimeField
      Alignment = taCenter
      FieldName = 'datahora_inclusao'
      DisplayFormat = 'dd/MM/yy hh:mm'
      EditMask = '99/99/99 99:99;1; '
    end
    object qryVolumesDadosfiscaisConferenciadatahora_alteracao: TDateTimeField
      Alignment = taCenter
      FieldName = 'datahora_alteracao'
      DisplayFormat = 'dd/MM/yy hh:mm'
      EditMask = '99/99/99 99:99;1; '
    end
    object qryVolumesDadosfiscaisConferenciausuario: TIntegerField
      FieldName = 'usuario'
    end
    object qryVolumesDadosfiscaisConferenciafilialregistro: TIntegerField
      FieldName = 'filialregistro'
    end
  end
  object dsrVolumesDadosfiscaisConferencia: TtecDataSource
    DataSet = qryVolumesDadosfiscaisConferencia
    OnDataChange = dsrVolumesDadosfiscaisConferenciaDataChange
    Left = 408
    Top = 120
  end
  ...
  object qryConferencia: TtecQuery
    ...
    object qryConferencialidos: TLargeintField
      FieldName = 'lidos'
    end
  ...
  object qryVolumesDadosFiscais: TtecQuery
    ...
    Sql.Strings = (
      ...
      '  rn.dadofiscal,'
      ''
      '  coalesce(nullif(vodf.codigo,0),1) as numerovolume,'
      ''
      '  coalesce(nullif(vodf.volumes,0),1) as volume,'
      
        '  generate_series(1, coalesce(nullif(vodf.volumes,0),1)) as nrvo' +
        'lume,'
      '  df.chv_nfe,'
      ''
      '  n.filial,'
      ...
      '  cast(df.chv_nfe||'
        ...
        '  lpad(cast(generate_series(1, coalesce(nullif(vodf.volumes,0),1' +
        ')) as varchar(3)),3,'#39'0'#39')||'
      
        '  lpad(cast(coalesce(vodf.volumes,1) as varchar(3)) ,3,'#39'0'#39') as v' +
        'archar(50)) as chv_nfevolumes'
      ''
      ''
    ...
    Left = 480
    Top = 88
    object qryVolumesDadosFiscaiscodigo: TStringField
      FieldName = 'codigo'
    end
    object qryVolumesDadosFiscaisdadofiscal: TIntegerField
      FieldName = 'dadofiscal'
    end
    object qryVolumesDadosFiscaisvolume: TIntegerField
      FieldName = 'volume'
    end
    object qryVolumesDadosFiscaisnrvolume: TIntegerField
      FieldName = 'nrvolume'
    end
    object qryVolumesDadosFiscaischv_nfe: TStringField
      FieldName = 'chv_nfe'
      Size = 44
    end
    object qryVolumesDadosFiscaischv_nfevolumes: TStringField
      FieldName = 'chv_nfevolumes'
      Size = 50
    end
    object qryVolumesDadosFiscaisfilial: TIntegerField
      FieldName = 'filial'
    end
    object qryVolumesDadosFiscaisserie: TStringField
      FieldName = 'serie'
      Size = 3
    end
    object qryVolumesDadosFiscaisnumero: TIntegerField
      FieldName = 'numero'
    end
    object qryVolumesDadosFiscaisnumerovolume: TIntegerField
      FieldName = 'numerovolume'
    end
  end
  ...
  object qryApagarRegistrosRPS: TtecQuery
    Tag = -1
    Database = dtmTecSoft.dbaTecSoft
    Transaction = dtmTecSoft.tstTecSoft
    CachedUpdates = True
    ...
    Sql.Strings = (
      'delete from volumesdadosfiscaisconferencia'
      'where (codigo,tipo) in'
      '('
      '  select c.codigo, c.tipo'
      '  from conferencia c'
      '  where c.codigo in (%codigo)'
      '    and c.tipo in ('#39'ROP'#39','#39'RPS'#39')'
      '    and exists (select crps.codigo'
      '                from conferencia crps'
      
        '                where crps.codigo = c.codigo and crps.tipo = '#39'RP' +
        'S'#39')'
      ');'
      ''
      'delete'
