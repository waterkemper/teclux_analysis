inherited frmCadastroProdutosEquipamentos: TfrmCadastroProdutosEquipamentos
  Left = 588
  Top = 207
  ActiveControl = flkProduto
  Caption = 'Cadastro de Produtos do Equipamento'
  ClientHeight = 134
  ClientWidth = 607
  PixelsPerInch = 96
  TextHeight = 16
  ...
  object pnlFundoJanela: TPanel
    ...
    object flkProduto: TtecDBFindLookup
      ...
      LookupField = 'codigo'
      LookupSource = dtmCadastroEquipamentos.dsrProcuraProduto
      LookupQueryParameter = 'produto'
      Parameter = ' '
