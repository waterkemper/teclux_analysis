object frmmensagemgridprodutosconferencia: Tfrmmensagemgridprodutosconferencia
  Left = 506
  Top = 90
  ...
  object lblTitulo: TLabel
    ...
    Alignment = taCenter
    AutoSize = False
    Caption = 'LISTA DE PRODUTOS N'#195'O CONFERIDOS'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clRed
    Font.Height = 20
  ...
  object dbgMensagem: TDBAdvGrid
    ...
    Font.Name = 'Tahoma'
    Font.Style = []
    Options = [goFixedVertLine, goFixedHorzLine, goVertLine, goRangeSelect, goRowSizing, goColSizing]
    ParentFont = False
    ScrollBars = ssBoth
    TabOrder = 1
    OnCustomCellSize = dbgMensagemCustomCellSize
  ...
  object dsrListaErros: TtecDataSource
    Left = 400
    Top = 192
  end
end
