object fraListaCargosouAtividades: TfraListaCargosouAtividades
  Left = 0
  Top = 0
  Width = 485
  Height = 167
  ...
  object qryCargosouAtividades: TtecQuery
    Tag = -1
    ...
    Left = 40
    Top = 32
    object qryCargosouAtividadescodigo: TIntegerField
      FieldName = 'codigo'
    end
    object qryCargosouAtividadesdescricao: TStringField
      FieldName = 'descricao'
      Size = 30
    end
  end
