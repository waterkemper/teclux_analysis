object fraListaclasseProdutos: TfraListaclasseProdutos
  Left = 0
  Top = 0
  Width = 396
  Height = 174
  ...
  object gbx: TGroupBox
    ...
    object clbclasseprodutos: TCheckListBox
      Left = 2
      Top = 21
      Width = 366
      Height = 151
  ...
  object qryclassesProdutos: TtecQuery
    Tag = -1
    ...
    Left = 40
    Top = 32
    object qryclassesProdutoscodigo: TStringField
      FieldName = 'codigo'
      Size = 2
    end
    object qryclassesProdutosdescricao: TStringField
      FieldName = 'descricao'
      Size = 30
    end
  end
