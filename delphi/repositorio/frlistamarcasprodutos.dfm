object fraListamarcasProdutos: TfraListamarcasProdutos
  Left = 0
  Top = 0
  Width = 396
  Height = 174
  ...
  object gbx: TGroupBox
    ...
    object clbmarcasprodutos: TCheckListBox
      Left = 2
      Top = 21
      Width = 366
      Height = 151
  ...
  object qrymarcassProdutos: TtecQuery
    Tag = -1
    ...
    Left = 40
    Top = 32
    object qrymarcassProdutoscodigo: TIntegerField
      FieldName = 'codigo'
    end
    object qrymarcassProdutosdescricao: TStringField
      FieldName = 'descricao'
      Size = 15
    end
  end
