object fraListaSeriesFiliais: TfraListaSeriesFiliais
  Left = 0
  Top = 0
  Width = 396
  Height = 174
  ...
  object gbx: TGroupBox
    ...
    object clbSeriesNotasFiscais: TCheckListBox
      Left = 2
      Top = 21
      Width = 366
      Height = 151
  ...
  object qrySeriesFiliais: TtecQuery
    ...
    Macros = <>
    Sql.Strings = (
      'Select DISTINCT (valor) as serie FROM seriesfiliais')
    RequestLive = False
    Left = 40
    Top = 32
    object qrySeriesFiliaisserie: TStringField
      FieldName = 'serie'
      Size = 3
    end
  end
