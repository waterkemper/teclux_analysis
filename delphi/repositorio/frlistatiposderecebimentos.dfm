object fraListaTiposdeRecebimentos: TfraListaTiposdeRecebimentos
  Left = 0
  Top = 0
  Width = 396
  Height = 174
  ...
  object gbx: TGroupBox
    ...
    object clbtiposderecebimentos: TCheckListBox
      Left = 2
      Top = 21
      Width = 366
      Height = 151
  ...
  object qryTiposdeRecebimentos: TtecQuery
    Tag = -1
    ...
    Sql.Strings = (
      ...
      ''
      '('
      'select cast('#39'999'#39' as integer) as codigo,'
      '          cast('#39'CHEQUES AVULSOS'#39' as varchar(100)) as descricao'
      ')'
      ') as selecao'
      'Order by descricao')
    RequestLive = True
    Left = 40
    Top = 32
    object qryTiposdeRecebimentoscodigo: TIntegerField
      FieldName = 'codigo'
      DisplayFormat = '0'
    end
    object qryTiposdeRecebimentosdescricao: TStringField
      FieldName = 'descricao'
      Size = 100
    end
  end
