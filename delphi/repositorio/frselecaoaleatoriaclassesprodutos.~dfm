object fraSelecaoaleatoriaclassesprodutos: TfraSelecaoaleatoriaclassesprodutos
  Left = 0
  Top = 0
  Width = 536
  Height = 328
  TabOrder = 0
  inline fraSelecaoAleatoriaClasseProduto: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 536
    Height = 328
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      ...
      Height = 313
      Align = alClient
      OnDblClick = fraSelecaoAleatoriaClasseProdutodbgSelecaoAleatoriaDblClick
      OnKeyDown = fraSelecaoAleatoriaClasseProdutodbgSelecaoAleatoriaKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'codigo'
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Left = 7
        OnClick = fraSelecaoaleatoriaclassesprodutosbnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      AfterOpen = fraSelecaoAleatoriaClasseProdutoqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriaClasseProdutoqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
