unit frselecaoaleatoriacontratos;
...
type
  TfraSelecaoAleatoriacontratos = class(TFrame)
    fraSelecaoAleatoriaContrato: TfraSelecaoAleatoria;
    procedure fraSelecaoAleatoriacontratosqrySelecaoAleatoriaAfterOpen(
      DataSet: TDataSet);
    procedure fraSelecaoAleatoriacontratosqrySelecaoAleatoriaNewRecord(
      DataSet: TDataSet);
    procedure fraSelecaoAleatoriacontratosdbgSelecaoAleatoriaDblClick(
      Sender: TObject);
    procedure fraSelecaoAleatoriacontratossbnProcuraClick(Sender: TObject);
...
procedure TfraSelecaoAleatoriacontratos.fraSelecaoAleatoriacontratosqrySelecaoAleatoriaAfterOpen(
  DataSet: TDataSet);
begin
...
procedure TfraSelecaoAleatoriacontratos.fraSelecaoAleatoriacontratosqrySelecaoAleatoriaNewRecord(
  DataSet: TDataSet);
begin
  with fraSelecaoAleatoriaContrato do
  begin
...
procedure TfraSelecaoAleatoriacontratos.fraSelecaoAleatoriacontratosdbgSelecaoAleatoriaDblClick(
  Sender: TObject);
begin
...
procedure TfraSelecaoAleatoriacontratos.fraSelecaoAleatoriacontratossbnProcuraClick(
  Sender: TObject);
begin
  AcionarPesquisaGrade;
...
constructor TfraSelecaoAleatoriacontratos.Create(AOwner: TComponent);
begin
  inherited;
...
//    ConsultaSelecaoAleatoria.CondicoesdaConsulta := CondicoesFluxoGramasOperacoes;
    ConsultaSelecaoAleatoria.TipoPesquisa := pescontratos;
    ConsultaSelecaoAleatoria.OnFound := AtribuirDadoscontratos;
...
function TfraSelecaoAleatoriacontratos.GetListaCondicional: String;
begin
  result := trocar(fraSelecaoAleatoriaContrato.ListaCondicional, 'contrato','ct.numero');
  result := trocar(result, 'nome','ct.nome');
end;

procedure TfraSelecaoAleatoriacontratos.AtribuirDadoscontratos(Found: Boolean);
begin
  with fraSelecaoAleatoriaContrato do
  begin
...
procedure TfraSelecaoAleatoriacontratos.AcionarPesquisaGrade;
begin
  with fraSelecaoAleatoriaContrato do
  begin
    dbgSelecaoAleatoria.SetFocus;
    ConsultaSelecaoAleatoria.CtrlOn := True;
    ConsultaSelecaoAleatoria.InternoPesquisar('contratos');
    dbgSelecaoAleatoria.SetFocus;
    dbgSelecaoAleatoria.SelectedIndex :=  0;
  end;
end;

procedure TfraSelecaoAleatoriacontratos.fraSelecaoAleatoriaContratodbgSelecaoAleatoriaKeyDown(
  Sender: TObject; var Key: Word; Shift: TShiftState);
begin
