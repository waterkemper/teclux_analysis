object fraSelecaoAleatoriacontratos: TfraSelecaoAleatoriacontratos
  Left = 0
  Top = 0
  Width = 593
  Height = 324
  ...
  inline fraSelecaoAleatoriaContrato: TfraSelecaoAleatoria
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      ...
      OnDblClick = fraSelecaoAleatoriacontratosdbgSelecaoAleatoriaDblClick
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Hint = 'CTRL + F9 - Procurar contratos'
        OnClick = fraSelecaoAleatoriacontratossbnProcuraClick
      end
      inherited sbnExcluir: TSpeedButton
        Hint = 'Excluir Contrato'
      end
      inherited sbnExcluirTodos: TSpeedButton
        Hint = 'Excluir todos os contratos da lista'
      end
      inherited sbnIncluirItem: TSpeedButton
        Hint = 'Incluir contratos na lista'
      end
    end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      ...
      AfterOpen = fraSelecaoAleatoriacontratosqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriacontratosqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
