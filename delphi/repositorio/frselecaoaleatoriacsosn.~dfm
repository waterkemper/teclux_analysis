object fraSelecaoAleatoriacsosn: TfraSelecaoAleatoriacsosn
  Left = 0
  Top = 0
  Width = 508
  Height = 328
  TabOrder = 0
  inline fraSelecaoAleatoriacsosn: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 508
    Height = 328
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      Width = 476
      Height = 313
      OnDblClick = fraSelecaoAleatoriacsosndbgSelecaoAleatoriaDblClick
      OnKeyDown = fraSelecaoAleatoriacsosndbgSelecaoAleatoriaKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'codigo'
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Left = 7
        OnClick = fraSelecaoAleatoriacsosnbnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      AfterOpen = fraSelecaoAleatoriacsosnqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriacsosnqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
