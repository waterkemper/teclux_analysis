object fraSelecaoAleatoriacst: TfraSelecaoAleatoriacst
  Left = 0
  Top = 0
  Width = 508
  Height = 328
  TabOrder = 0
  inline fraSelecaoAleatoriacst: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 508
    Height = 328
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      Width = 476
      Height = 313
      OnDblClick = fraSelecaoAleatoriacstdbgSelecaoAleatoriaDblClick
      OnKeyDown = fraSelecaoAleatoriacstdbgSelecaoAleatoriaKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'codigo'
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Left = 7
        OnClick = fraSelecaoAleatoriacstbnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      AfterOpen = fraSelecaoAleatoriacstqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriacstqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
