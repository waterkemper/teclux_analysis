object fraSelecaoAleatoriadocumentospag: TfraSelecaoAleatoriadocumentospag
  ...
  Height = 324
  TabOrder = 0
  inline fraSelecaoAleatoriaDocumentosPag: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 593
    Height = 324
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      ...
      OnKeyDown = fraSelecaoAleatoriaDocumentosPagdbgSelecaoAleatoriaKeyDown
      DefaultRowHeight = 19
      Columns = <
        item
          Expanded = False
        ...
        item
          ...
          FieldName = 'nome'
          Title.Alignment = taCenter
          Title.Caption = 'Nome do Fornecedor/Cliente'
          Width = 208
          Visible = True
        end
        item
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Hint = 'CTRL + F9 - Procurar documentos'
      ...
      inherited sbnExcluirTodos: TSpeedButton
        Hint = 'Excluir todos os documentos da lista'
      end
      inherited sbnIncluirItem: TSpeedButton
        Hint = 'Incluir documento na lista'
      end
    end
