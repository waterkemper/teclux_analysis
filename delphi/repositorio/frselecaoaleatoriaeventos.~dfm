object fraSelecaoAleatoriaeventos: TfraSelecaoAleatoriaeventos
  Left = 0
  Top = 0
  Width = 508
  Height = 328
  TabOrder = 0
  inline fraSelecaoAleatoriaeventos: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 508
    Height = 328
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      Width = 476
      Height = 313
      OnDblClick = fraSelecaoAleatoriaeventosdbgSelecaoAleatoriaDblClick
      OnKeyDown = fraSelecaoAleatoriaeventosdbgSelecaoAleatoriaKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'codigo'
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Left = 8
        Width = 22
        OnClick = fraSelecaoAleatoriaeventosbnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      AfterOpen = fraSelecaoAleatoriaeventosqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriaeventosqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
