object fraSelecaoAleatoriagruposfornecedores: TfraSelecaoAleatoriagruposfornecedores
  Left = 0
  Top = 0
  Width = 564
  Height = 328
  TabOrder = 0
  inline fraSelecaoAleatoriaGruposFornecedores: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 564
    Height = 328
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      Width = 532
      Height = 313
      OnDblClick = fraSelecaoAleatoriagruposfornecedoresdbgSelecaoAleatoriaDblClick
      OnKeyDown = fraSelecaoAleatoriagruposfornecedoresdbgSelecaoAleatoriaKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'codigo'
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Left = 7
        OnClick = fraSelecaoAleatoriagruposfornecedoresbnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      AfterOpen = fraSelecaoAleatoriagruposfornecedoresqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriagruposfornecedoresqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
