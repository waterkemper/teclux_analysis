object fraSelecaoAleatoriagruposusuarios: TfraSelecaoAleatoriagruposusuarios
  Left = 0
  Top = 0
  Width = 508
  Height = 328
  TabOrder = 0
  inline fraSelecaoAleatoriagruposusuarios: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 508
    Height = 328
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      Width = 476
      Height = 313
      OnDblClick = fraSelecaoAleatoriagruposusuariosdbgSelecaoAleatoriaDblClick
      OnKeyDown = fraSelecaoAleatoriagruposusuariosdbgSelecaoAleatoriaKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'codigo'
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Left = 7
        OnClick = fraSelecaoAleatoriagruposusuariosbnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      AfterOpen = fraSelecaoAleatoriagruposusuariosqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriagruposusuariosqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
