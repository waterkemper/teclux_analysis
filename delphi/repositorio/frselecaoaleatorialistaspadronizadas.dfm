object fraSelecaoaleatorialistaspadronizadas: TfraSelecaoaleatorialistaspadronizadas
  Left = 0
  Top = 0
  Width = 508
  Height = 328
  TabOrder = 0
  inline fraSelecaoAleatoriaListasPadronizadas: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 508
    Height = 328
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      Width = 476
      Height = 313
      OnDblClick = fraSelecaoAleatoriaListasPadronizadasdbgSelecaoAleatoriaDblClick
      OnKeyDown = fraSelecaoAleatoriaListasPadronizadasdbgSelecaoAleatoriaKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'codigo'
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Left = 7
        OnClick = fraSelecaoaleatorialistaspadronizadasbnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      AfterOpen = fraSelecaoAleatoriaListasPadronizadasqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriaListasPadronizadasqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
