object fraSelecaoaleatoriamarketplace: TfraSelecaoaleatoriamarketplace
  Left = 0
  Top = 0
  Width = 534
  Height = 328
  TabOrder = 0
  inline fraSelecaoAleatoriamarketplace: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 534
    Height = 328
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      ...
      Height = 313
      Align = alClient
      OnDblClick = fraSelecaoAleatoriamarketplacedbgSelecaoAleatoriaDblClick
      OnKeyDown = fraSelecaoAleatoriamarketplacedbgSelecaoAleatoriaKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'codigo'
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Left = 7
        OnClick = fraSelecaoaleatoriamarketplacebnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      AfterOpen = fraSelecaoAleatoriamarketplaceqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriamarketplaceqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
