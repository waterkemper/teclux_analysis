object fraselecaoaleatorianotassaidas: Tfraselecaoaleatorianotassaidas
  Left = 0
  Top = 0
  Width = 819
  Height = 275
  TabOrder = 0
  inline fraselecaoaleatorianotassaidas: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 819
    Height = 228
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      ...
      OnDblClick = fraselecaoaleatorianotassaidasdbgSelecaoAleatoriaDblClick
      OnKeyDown = fraselecaoaleatorianotassaidasdbgSelecaoAleatoriaKeyDown
      DefaultRowHeight = 19
      Columns = <
        item
          Expanded = False
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        ...
        OnClick = fraselecaoaleatorianotassaidassbnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      ...
      AfterOpen = fraselecaoaleatorianotassaidasqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraselecaoaleatorianotassaidasqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
