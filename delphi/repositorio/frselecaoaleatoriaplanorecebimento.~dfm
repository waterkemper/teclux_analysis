object fraSelecaoAleatoriaplanorecebimento: TfraSelecaoAleatoriaplanorecebimento
  Left = 0
  Top = 0
  Width = 508
  Height = 328
  TabOrder = 0
  inline fraSelecaoAleatoriaplanorecebimento: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 508
    Height = 328
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      Width = 476
      Height = 313
      OnDblClick = fraSelecaoAleatoriaplanorecebimentodbgSelecaoAleatoriaDblClick
      OnKeyDown = fraSelecaoAleatoriaplanorecebimentodbgSelecaoAleatoriaKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'codigo'
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Left = 7
        OnClick = fraSelecaoAleatoriaplanorecebimentobnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      AfterOpen = fraSelecaoAleatoriaplanorecebimentoqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriaplanorecebimentoqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
