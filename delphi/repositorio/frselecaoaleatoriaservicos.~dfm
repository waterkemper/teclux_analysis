object fraSelecaoaleatoriaservicos: TfraSelecaoaleatoriaservicos
  Left = 0
  Top = 0
  Width = 508
  Height = 328
  TabOrder = 0
  inline fraSelecaoAleatoriaservicos: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 508
    Height = 328
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      ...
      Height = 313
      Align = alClient
      OnDblClick = fraSelecaoAleatoriaservicosdbgSelecaoAleatoriaDblClick
      OnKeyDown = fraSelecaoAleatoriaservicosdbgSelecaoAleatoriaKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'codigo'
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Left = 7
        OnClick = fraSelecaoaleatoriaservicosbnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      AfterOpen = fraSelecaoAleatoriaservicosqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriaservicosqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
