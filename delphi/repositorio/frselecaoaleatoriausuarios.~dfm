object fraSelecaoAleatoriausuarios: TfraSelecaoAleatoriausuarios
  Left = 0
  Top = 0
  Width = 508
  Height = 328
  TabOrder = 0
  inline fraSelecaoAleatoriausuarios: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 508
    Height = 328
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      Width = 476
      Height = 313
      OnDblClick = fraSelecaoAleatoriausuariosdbgSelecaoAleatoriaDblClick
      OnKeyDown = fraSelecaoAleatoriausuariosdbgSelecaoAleatoriaKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'codigo'
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Left = 7
        OnClick = fraSelecaoAleatoriausuariosbnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      AfterOpen = fraSelecaoAleatoriausuariosqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriausuariosqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
