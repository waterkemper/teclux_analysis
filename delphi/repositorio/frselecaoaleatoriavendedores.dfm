object fraSelecaoAleatoriavendedores: TfraSelecaoAleatoriavendedores
  Left = 0
  Top = 0
  Width = 508
  Height = 328
  TabOrder = 0
  inline fraSelecaoAleatoriavendedores: TfraSelecaoAleatoria
    Left = 0
    Top = 0
    Width = 508
    Height = 328
    ...
    inherited dbgSelecaoAleatoria: TtecDBGrid
      Width = 476
      Height = 313
      OnDblClick = fraSelecaoAleatoriavendedoresdbgSelecaoAleatoriaDblClick
      OnKeyDown = fraSelecaoAleatoriavendedoresdbgSelecaoAleatoriaKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'codigo'
    ...
    inherited pnlLabels: TPanel
      ...
      inherited sbnProcura: TSpeedButton
        Left = 7
        OnClick = fraSelecaoAleatoriavendedoresbnProcuraClick
      end
    ...
    inherited qrySelecaoAleatoria: TtecQuery
      AfterOpen = fraSelecaoAleatoriavendedoresqrySelecaoAleatoriaAfterOpen
      OnNewRecord = fraSelecaoAleatoriavendedoresqrySelecaoAleatoriaNewRecord
      Sql.Strings = (
