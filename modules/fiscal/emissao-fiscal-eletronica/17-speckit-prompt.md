...
Crie uma especificação funcional e técnica detalhada para transferir administrativamente uma emissão elegível do Delphi para o Laravel. Depende de `02-speckit-prompt.md` e `16-speckit-prompt.md`.
...
- sincronização imediatamente anterior, A1 ativo, consulta SEFAZ e validação de evidências;
...
- usuário sem reautenticação, A1 ausente, evidência divergente, processamento ativo ou Delphi não inativo bloqueiam;
